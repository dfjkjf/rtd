...
1. **场景一：日常对话**
   - "Can we meet at 3 PM?" "Okay, that works for me."
   - "我们下午3点见面可以吗？" "好的，我没问题。"
...
3. **场景三：确认信息**
   - "So, the meeting is scheduled for tomorrow?" "Yes, okay."
   - "那么，会议是安排在明天吗？" "是的，没错。"
...
1. **场景一：描述人**
   ...
   - 她是我的一位老朋友。
2. **场景二：描述物品**
   - This is an old photograph of my family.
   - 这是我家庭的一张老照片。
3. **场景三：描述建筑**
...
1. Please don't omit any details in your report.  
   **翻译**: 请不要在你的报告中遗漏任何细节。

2. She omitted to mention the cost of the project.  
   **翻译**: 她没有提到项目的成本。

3. The editor decided to omit the last chapter of the book.  
   **翻译**: 编辑决定省略书的最后一章。
...
1. **基数词用法**：
   ...
   - "我有一个苹果。"
2. **代词用法**：
   - "One of the students forgot their book."
   - "其中一个学生忘了带书。"
3. **表达唯一或统一**：
   - "We are one team."
   - "我们是一个团队。"
...
1. I chopped an onion and added it to the soup.  
   **翻译**: 我把洋葱切碎，加到了汤里。
2. The smell of onions made my eyes water.  
   **翻译**: 洋葱的气味让我的眼睛流泪。
3. She prefers to use red onions in her salads.  
   **翻译**: 她更喜欢在沙拉中使用红洋葱。
...
3. **场景三：技术应用**
   - The software was uploaded onto the server.
   - 软件被上传到了服务器上。
...
3. **场景三：自然景观**
   - "We had a picnic in the open field."
   - “我们在开阔的草地上野餐。”
...
1. "She has been studying opera singing for five years."  
   **翻译**: "她已经学习歌剧演唱五年了。"
   
2. "The opera house in Milan is famous for its acoustics."  
   **翻译**: "米兰的歌剧院以其音响效果闻名。"
   
3. "We bought tickets to see an opera performance next weekend."  
   **翻译**: "我们买了下周末看歌剧表演的票。"
...
1. **场景一：电话接线员**
   - The operator connected me to the wrong number.
   - 接线员给我接错了号码。

2. **场景二：手术室中的操作员**
   - The surgical operator was highly skilled and performed the procedure flawlessly.
   - 手术操作员技术高超，手术进行得非常顺利。

3. **场景三：编程中的运算符**
   - In Python, the '+' operator is used for both addition and string concatenation.
   - 在 Python 中，“+”运算符既用于加法，也用于字符串连接。
...
1. **场景一：讨论政治**
   - "In my opinion, the new policy will benefit the economy."
   - “在我看来，新政策将有利于经济。”

2. **场景二：评价电影**
   - "She shared her opinion about the movie after watching it."
   - “看完电影后，她分享了她对这部电影的看法。”

3. **场景三：课堂讨论**
   - "The teacher asked the students to express their opinions on the topic."
   - “老师要求学生们就这个话题表达自己的看法。”
...
1. "I saw an opportunity to start my own business after losing my job."  
   **翻译**: “在失业后，我看到了创业的机会。”

2. "She took the opportunity to travel abroad during her summer vacation."  
   **翻译**: “她利用暑假的机会去国外旅行。”

3. "The company is looking for new opportunities in the Asian market."  
   **翻译**: “公司正在寻找进入亚洲市场的新机会。”
...
2. **场景二：工作环境**
   - The employees decided to oppose the company's decision to cut benefits.
   - 员工们决定反对公司削减福利的决定。

3. **场景三：个人关系**
   - She opposed her friend's idea of moving to another city.
   - 她反对她朋友搬到另一个城市的想法。
...
1. She remained optimistic even when things looked bleak.  
   **翻译**: 即使情况看起来很糟糕，她仍然保持乐观。

2. An optimistic attitude can help you overcome challenges.  
   **翻译**: 乐观的态度可以帮助你克服挑战。

3. The coach was optimistic about the team's chances of winning.  
   **翻译**: 教练对球队获胜的机会持乐观态度。
...
1. **场景：教育**  
   - The teacher gave an oral presentation on the history of ancient Rome.  
   - 老师做了一个关于古罗马历史的口头报告。

2. **场景：医学**  
   - The doctor prescribed an oral medication to treat the patient's infection.  
   - 医生开了一种口服药物来治疗病人的感染。

3. **场景：语言学习**  
   - During the language class, students practiced their oral skills by having conversations with each other.  
   - 在语言课上，学生们通过互相交谈来练习口语技能。
...
- **固定搭配**: "symphony orchestra"（交响乐团）, "concert orchestra"（音乐会管弦乐队）, "orchestral music"（管弦乐）, "orchestrate a plan"（策划一个计划）.  交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、管弦乐、策划一个计划。  固定搭配交响乐团、音乐会管弦乐队、
...
3. **场景三：学校生活**
   - "The teacher asked an ordinary question in class."
   - "老师在课堂上问了一个普通的问题。"
...
2. Even the smallest organism can have a significant impact on its environment.  
   **翻译**: 即使是最小的生物也能对其环境产生重大影响。
3. The organism was able to adapt to the changing climate conditions.  
...
1. **场景一：工作安排**
   - She organized the meeting by arranging the chairs in a circle.
   - 她通过将椅子摆成一个圆圈来组织会议。

2. **场景二：活动策划**
   - We need to organize a charity event to raise funds for the school.
   - 我们需要组织一个慈善活动来为学校筹集资金。
...
1. **场景一：建议与警告**
   - "You should wear a coat. Otherwise, you might catch a cold."
   - "你应该穿件外套。否则，你可能会感冒。"

2. **场景二：描述不同情况**
   - "The weather was nice today, but it might be otherwise tomorrow."
   - "今天天气很好，但明天可能就不一样了。"

3. **场景三：表达不同观点**
   - "I think he is honest. Otherwise, why would he help us so much?"
   - "我认为他是诚实的。否则，他为什么要帮我们这么多？"
...
1. **场景一：家庭**
   ...
   - “我们的房子非常舒适。”
2. **场景二：工作**
   - "Let's discuss our project plan."
   - “让我们讨论一下我们的项目计划。”
3. **场景三：学校**
...
2. **场景二：体育比赛**  
   - The outcome of the match was uncertain until the last minute.  
   - 比赛的结果直到最后一分钟才确定。

3. **场景三：商业决策**  
   - The company is waiting to see the outcome of the new marketing strategy.  
   - 公司正在等待新营销策略的结果。
...
1. The outer layer of the cake is made of chocolate.  
   蛋糕的外层是由巧克力制成的。
   
2. We parked our car in the outer part of the parking lot.  
   我们把车停在了停车场的最外侧。
   
3. The outer walls of the castle were very thick.  
   城堡的外墙非常厚。
...
2. **场景二：景色与视野**
   - "The outlook from the hotel balcony was breathtaking."
   - 从酒店阳台看到的景色令人叹为观止。
...
1. **场景一：家庭厨房**
   - She preheated the oven to 350°F before putting the cake in.
   - 她在把蛋糕放入烤箱之前，先将烤箱预热到350华氏度。

2. **场景二：面包店**
   - The baker checked the bread in the industrial oven to ensure it was perfectly baked.
   - 面包师检查了工业烤箱里的面包，确保它烤得恰到好处。

3. **场景三：野营**
   - They built a makeshift oven using stones to cook their meal over the campfire.
   - 他们用石头搭建了一个临时的烤箱，在篝火上煮饭。
...
1. **场景一：寒冷的冬天**
   - He put on his overcoat before going out into the freezing cold.
   - 他在出门进入严寒之前穿上了他的大衣。

2. **场景二：商务场合**
   - The businessman wore a sleek overcoat to the important meeting.
   - 这位商人在重要会议上穿了一件时尚的大衣。

3. **场景三：火车站**
   - As she waited for the train, she wrapped her overcoat tightly around herself for warmth.
   - 她在等火车时，紧紧裹着她的大衣以保暖。
...
1. She was determined to overcome her fear of public speaking.  
   **翻译**: 她决心克服对公众演讲的恐惧。
   
2. The team worked hard to overcome the challenges they faced.  
   **翻译**: 团队努力克服他们面临的挑战。
   
3. He overcame his shyness and made new friends at the party.  
...
1. **忽视/忽略**
   - "She overlooked the small details in the report."  
     她忽略了报告中的小细节。
   
2. **俯瞰**
   - "The hotel room offers a beautiful view that overlooks the city."  
     酒店房间提供了一个俯瞰城市的美丽景色。
   
3. **忽视/忽略**
   - "He tends to overlook his own mistakes."  
     他往往忽视自己的错误。
...
1. **场景一：旅行**
   - She has been planning an overseas trip for months.
   - 她已经计划了几个月的海外旅行。
   
2. **场景二：工作**
   - Many companies have overseas branches to expand their business.
   - 许多公司都有海外分支机构以扩展业务。
   
3. **场景三：教育**
   - He is an overseas student studying at a prestigious university in the UK.
   - 他是一名在英国一所著名大学学习的留学生。
...
- **固定搭配**: take ownership of something（对某物负责或承担责任）, joint owner（共同所有者）.
   - Example: She took ownership of the project and ensured its success. (她对这个项目负责并确保其成功。)  她对这个项目负责并确保其成功。)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)  她对这个项目负责并确保其成功.)
