...
1. **场景一：旅行**
   - We need to drive farther to reach the next town.
   - 我们需要开得更远才能到达下一个城镇。
...
3. **场景三：历史**
   - The archaeologists found artifacts farther back in time than they had expected.
   - 考古学家发现了比预期更早时间的文物。
...
- **固定搭配**: follow the fashion (追随时尚), set the fashion (引领时尚)。例如: She always follows the latest fashion trends. (她总是追随最新的时尚潮流)。  她总是追随最新的时尚潮流. set the fashion引领时尚.例如: Her new hairstyle has set a new fashion trend.(她的新发型引领了新的时尚潮流.)  她的新发型引领了新的时尚潮流. follow the fashion追随时尚.例如: He likes to follow the latest fashions.(他喜欢追随最新的流行趋势.)  他喜欢追随最新的流行趋势. set the fashion引领时尚.例如: The brand's innovative designs have set a new fashion trend.(这个品牌的创新设计引领了新的时尚潮流.)  这个品牌的创新设计引领了新的时尚潮流. follow the fashion追随时尚.例如: Many young people like to follow the latest fashions.(很多年轻人喜欢追随最新的流行趋势.)  很多年轻人喜欢追随最新的流行趋势. set the fashion引领时尚.例如: The movie star's style has set a new fashion trend.(这位电影明星的风格引领了新的时尚潮流.)  这位电影明星的风格引领了新的时尚潮流. follow the fashion追随时尚.例如: She always tries to follow the latest fashions.(她总是试图追随最新的流行趋势.)  她总是试图追随最新的流行趋势. set the fashion引领
...
- **固定搭配:** hold fast (抓紧), stand fast (坚定不移), fast food (快餐), fast forward (快进) [名词形式]
   - Fast food restaurants are popular because they serve quickly. (快餐店很受欢迎，因为它们上菜很快。) [固定搭配]  【快餐店很受欢迎因为它们上菜很快】  【固定搭配】hold fast抓紧, stand fast坚定不移, fast food快餐, fast forward快进[名词形式]
...
2. **场景二：工作环境中的使用**
   - "The carpenter fastened the wooden planks together with nails."
   - “木匠用钉子将木板固定在一起。”

3. **场景三：户外活动中的使用**
   - "She fastened the tent poles to ensure it wouldn't collapse during the storm."
   - “她把帐篷杆固定好，以确保在暴风雨中不会倒塌。”
...
### 列举例句
1. **场景一：健康与饮食**
   - Eating too much junk food can make you fat.
   - 吃太多垃圾食品会让你变胖。
   
2. **场景二：烹饪**
   - She used a lot of fat to fry the potatoes.
   - 她用了很多油来炸土豆。
...
1. "She believed that her fate was already decided by the stars."
   - **翻译**: "她相信她的命运已经被星星决定了。"

2. "Despite all his efforts, he couldn't escape his fate."
   - **翻译**: "尽管他尽了全力，他还是无法逃脱他的命运。"

3. "The two lovers were destined to meet, as if by fate."
...
- **相关搭配**: 
  ...
  - leave to fate: 听天由命。
  - twist of fate: 命运的转折。  【遭遇不幸；听天由命；命运的转折】】】】】】】】】】】】】】】】】】】】
...
2. **场景二：宗教背景**
   - God is often referred to as the Father.
   - 上帝常被称为天父。

3. **场景三：历史或创造**
   - Thomas Edison fathered the modern electric light bulb.
   - 托马斯·爱迪生发明了现代电灯泡。
...
1. **场景一：日常生活**
   - "She felt a sudden fear when she heard the loud noise outside."
   - "当她听到外面的巨大噪音时，她突然感到一阵恐惧。"

2. **场景二：工作环境**
   - "The employees expressed their fear of losing their jobs during the company's restructuring."
   - "在公司重组期间，员工们表达了他们对失业的恐惧。"

3. **场景三：心理健康**
   - "He struggled with a deep-seated fear of failure that affected his daily life."
   - "他深受对失败的根深蒂固的恐惧所困扰，这影响了他的日常生活。"
...
### 列举例句
1. **场景一：个人情感**
   - She was fearful of the dark and always slept with the light on.
   - 她害怕黑暗，总是开着灯睡觉。

2. **场景二：描述事件**
   - The news of the accident was fearful, and many people were shocked.
   - 事故的消息令人恐惧，许多人感到震惊。

3. **场景三：文学描述**
   - The fearful storm caused widespread damage across the city.
   - 可怕的风暴给整个城市造成了广泛的破坏。
...
1. "February is the shortest month of the year."  
   **翻译**: "二月是一年中最短的月份。"
2. "We usually celebrate Valentine's Day in February."  
   **翻译**: "我们通常在二月庆祝情人节。"
3. "The weather in February can be quite cold."  
   **翻译**: "二月的天气可能会非常冷。"
...
2. **场景2: 学校学费**
   - The school fee has increased by 10% this year.
   - 今年的学费上涨了10%。

3. **场景3: 入场费**
   - There is a small entrance fee to visit the museum.
   - 参观博物馆需要支付少量入场费。
...
- The sheep feed on grass. (羊以草为食。) / The data is fed into the system. (数据被输入到系统中。) / I am fed up with waiting. (我等烦了。)
...
1. **场景：工作中的反馈**
   - **** My boss gave me some valuable feedback on my presentation.
   - **** 我的老板对我的演讲给出了一些有价值的反馈。

2. **场景：学习中的反馈**
   - **** The teacher asked the students to provide feedback on the new teaching method.
   - **** 老师要求学生们对新的教学方法提供反馈。

3. **场景：产品测试中的反馈**
   - **** We collected feedback from users about the new app's usability.
   - **** 我们收集了用户对新应用程序可用性的反馈。
...
1. **场景一：学术环境**
   - He was awarded a fellowship to study at Harvard University.
   - 他被授予了在哈佛大学学习的研究员职位。

2. **场景二：社交场合**
   - We had a great time chatting with our fellow travelers.
   - 我们和同行的旅客聊得很开心。

3. **场景三：工作环境**
   - John is a fellow in the marketing department.
   - 约翰是市场营销部门的一名同事。
...
2. **场景：动物描述**
   - The zoo has many female lions.
   - 动物园里有许多雌狮。
   
3. **场景：社会角色**
   - Female athletes are gaining more recognition these days.
   - 如今，女性运动员得到了更多的认可。
...
3. **场景三：市场交易**
   - "This antique vase can fetch a high price at auction."
   - “这个古董花瓶在拍卖会上能卖个好价钱。”
...
### 列举例句
1. **场景一：医疗**  
   - The doctor said she had a slight fever and should rest at home.  
   - 医生说她有点发烧，应该在家休息。

2. **场景二：日常生活**  
   - He felt a fever coming on after playing soccer in the hot sun.  
   - 他在烈日下踢完足球后，感觉自己要发烧了。

3. **场景三：文学描述**  
   - Her cheeks were flushed with fever, and her voice was weak.  
   - 她的脸因发烧而泛红，声音也很虚弱。
...
1. There are few opportunities left for new graduates in this field.  
   **翻译**: 这个领域留给新毕业生的机会很少。  
   
2. Few people understand the complexity of quantum physics.  
   **翻译**: 很少有人理解量子物理的复杂性。  
   
3. She had few friends in her new school.  
   **翻译**: 她在新学校几乎没有朋友。
...
3. **场景三：音乐**  
   - "The fifth note in the scale is called 'sol'."  
   - “音阶中的第五个音符叫做‘sol’。”
...
- **固定搭配**: "fifty-fifty" (对半分), "around fifty" (大约五十)。
   ...
   让我们把账单对半分吧；派对上有大约五十个人。）   让我们把账单对半分吧；派对上有大约五十个人。）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人）   让我们把账单对半分吧；派对上有大约五十个人
...
2. **场景二：充满情感**
   - His eyes filled with tears as he listened to the story.
   - 听故事时，他的眼睛充满了泪水。

3. **场景三：填充时间**
   - We need to fill the time until the movie starts.
   - 我们需要在电影开始前打发时间。
...
- fill in（填写）, fill out（填写表格）, fill up（装满）。
...
1. **场景一：日常生活中的过滤器**
   - "Please remember to change the water filter in the coffee machine."
   - "请记得更换咖啡机里的水过滤器。"

2. **场景二：信息筛选**
   - "Social media platforms use algorithms to filter out inappropriate content."
   - "社交媒体平台使用算法来过滤掉不适当的内容。"

3. **场景三：过滤空气**
   - "The air purifier helps to filter the dust and allergens from the room."
   - "空气净化器有助于过滤房间中的灰尘和过敏原。"
...
1. **场景一：个人理财**
   - She is very good at managing her financial affairs.
   - 她非常擅长管理自己的财务事务。
   
2. **场景二：公司财务**
   - The company's financial report shows a significant increase in profits.
   - 公司的财务报告显示利润显著增加。
   
3. **场景三：政府财政**
   - The government is facing a financial crisis due to the pandemic.
   - 由于疫情，政府正面临财政危机。
...
3. **场景三：表达看法**
   - I find this movie quite interesting.
   - 我觉得这部电影相当有趣。
...
1. **场景一：日常任务**
   - I need to finish my homework before I can watch TV.
   - 我需要先完成作业才能看电视。
...
3. **场景三：表面处理**
   - This table has a smooth finish.
   - 这张桌子有光滑的表面处理。
...
3. **场景三：初次经历**
   - "It was my first time visiting Paris."
   - “这是我第一次去巴黎。”
...
2. **场景二：描述活动**
   - My grandfather loves to fish in the river.
   - 我爷爷喜欢在河里钓鱼。
...
1. **场景一：服装**
   - "The new suit fits him perfectly."
   - "这套新西装非常适合他。"
...
### 列举例句
1. **场景一：描述食物**  
   - "The steak was cooked to perfection, with just the right amount of juicy flesh."  
   - “这块牛排烹调得恰到好处，肉质鲜嫩多汁。”

2. **场景二：描述人体**  
   - "He could feel the warmth of her flesh as they hugged."  
   - “他们拥抱时，他能感受到她身体的温暖。”

3. **场景三：比喻用法**  
   - "The novel explores the flesh and spirit of human existence."  
   - “这部小说探讨了人类存在的肉体与精神。”
...
### 列举例句
1. **场景一：烘焙**
   - She mixed the flour, sugar, and eggs to make a cake.
   - 她把面粉、糖和鸡蛋混合在一起做蛋糕。
   
2. **场景二：烹饪**
   - The chef added a pinch of flour to thicken the soup.
   - 厨师加了一撮面粉来使汤变稠。
   
3. **场景三：农业**
   - The farmer harvested wheat to produce flour for the local market.
   - 农民收获小麦，为当地市场生产面粉。
...
2. **场景二：庆祝活动**
   - The bride carried a bouquet of flowers down the aisle.
   - 新娘捧着一束花沿着过道走下来。
   
3. **场景三：自然景观**
   - The mountainside was covered in wildflowers during spring.
   - 春天时，山坡上开满了野花。
...
2. **场景二：乘坐飞机**
   - She will fly to Paris next week.
   - 她下周将乘飞机去巴黎。
   
3. **场景三：快速移动**
   - He flew out of the room when he heard the news.
   - 他听到消息后飞快地跑出了房间。
...
- **词缀**: "fog" 是一个基本词汇，没有明显的词缀。然而，它可以与其他词缀结合形成新词，例如：
  - **foggy** (形容词): 表示“有雾的”或“模糊的”。
    - The morning was foggy, and the mountains were barely visible.  
      （早晨有雾，山脉几乎看不见。）
  - **fogbound** (形容词): 表示“因雾受阻的”。
    - The airport was fogbound, and all flights were delayed.  
      （机场因雾受阻，所有航班都被延误了。）
...
- **形容词**: foggy (有雾的)  
- **动词**: fog up (使模糊)  
  - The windows fogged up from the steam inside the car.  
    （车内的蒸汽使窗户变得模糊。）  
- **固定搭配**:  
  - **in a fog**: 困惑不解  
    - I was in a fog during the meeting and didn't understand what was going on.  
...
1. **场景一：物理跟随**
   - She followed her brother into the room.
   - 她跟着她哥哥进了房间。
...
2. **场景二：描述对人的情感**
   - He is fond of his little sister.
   - 他很喜欢他的小妹妹。
...
1. **场景一：日常饮食**
   - "I always make sure to eat a balanced diet that includes plenty of fruits, vegetables, and whole grains."
   - "我总是确保吃均衡的饮食，包括大量的水果、蔬菜和全谷物。"

2. **场景二：餐厅点餐**
   - "The restaurant offers a wide variety of international foods, from Italian pasta to Japanese sushi."
   - "这家餐厅提供各种各样的国际美食，从意大利面到日本寿司。"

3. **场景三：健康饮食**
   - "Eating healthy food is essential for maintaining good health and preventing diseases."
   - "吃健康的食物对于保持良好健康和预防疾病至关重要。"
...
3. **场景三：文学描述**
   - "She placed her bare foot on the cool grass."
   - "她把赤裸的脚放在凉爽的草地上。"
...
### 列举例句
1. **场景一：学校体育课**
   - "We played football during the PE class today."
   - "我们今天在体育课上踢了足球。"
   
2. **场景二：观看比赛**
   - "My family loves watching football matches on TV."
   - "我的家人喜欢在电视上看足球比赛。"
   
3. **场景三：谈论球队**
   - "Liverpool is my favorite football team."
   - "利物浦是我最喜欢的足球队。"
...
1. **场景一：描述声音**
   - I heard the faint footstep of someone approaching the door.
   - 我听到有人走近门口的轻微脚步声。
   
2. **场景二：描述痕迹**
   - The detective followed the footstep in the snow to track the suspect.
   - 侦探跟着雪地里的脚印追踪嫌疑人。
   
3. **场景三：比喻影响**
   - Her father's footstep in the business world inspired her to pursue a career in finance.
   - 她父亲在商界的影响激励她追求金融事业。
...
10. **因为**：For he is a good friend, I trust him completely.  
    - 因为他是个好朋友，我完全信任他。（注意这里的“for”引导原因状语从句）。    
...
2. **场景二：工作场所**
   - The company forbids employees from using their phones during meetings.
   - 公司禁止员工在会议期间使用手机。
...
2. **场景二：医学描述**
   - The doctor checked the temperature on the patient's forehead.
   - 医生检查了病人额头上的温度。

3. **场景三：艺术描述**
   - The painting captured the delicate lines on the woman's forehead.
   - 这幅画捕捉到了女人额头上的细微线条。
...
### 列举例句
1. **场景一：国际贸易**
   - "The company imports foreign goods to meet local demand."
   - "这家公司进口外国商品以满足本地需求。"
   
2. **场景二：文化交流**
   - "She felt a bit out of place due to the foreign customs."
   - "由于不熟悉的外国习俗，她感到有些不自在。"
   
3. **场景三：语言学习**
   - "Learning a foreign language can be challenging but rewarding."
   - "学习一门外语可能具有挑战性，但也非常有回报。"
...
1. **场景一：旅行**
   - "The foreigner asked the local for directions to the nearest train station."
   - "那个外国人向当地人询问去最近火车站的路线。"
   
2. **场景二：工作环境**
   - "Our company has many foreigners working in various departments."
   - "我们公司有许多外国人在各个部门工作。"
   
3. **场景三：文化交流**
   - "The foreigner was fascinated by the traditional dance performance."
   - "那个外国人对传统舞蹈表演感到非常着迷。"
...
### 单词变形和固定搭配、组词及对应的中文翻译:  无变形形式；固定搭配如：treat a foreigner (对待外国人)、feel like a foreigner (感觉像个外国人)、foreigner's visa (外国人居留签证)等。  对待外国人、感觉像个外国人、外国人居留签证等。  注意：该单词主要为名词形式使用,没有复杂的变形形式,但可以与其他词语组合成固定搭配使用,以表达不同的语境和含义。
...
1. The Amazon rainforest is the largest tropical forest in the world.  
   **翻译**: 亚马逊雨林是世界上最大的热带森林。
2. Many animals live in the forest, including bears and deer.  
   **翻译**: 许多动物生活在森林里，包括熊和鹿。
3. We went hiking in the forest last weekend.  
   **翻译**: 上周末我们去森林里徒步旅行了。
...
2. **场景二：正式信函**
   - Please submit your report in formal language.
   - 请用正式的语言提交你的报告。

3. **场景三：正式教育**
   - The professor gave a formal lecture on quantum mechanics.
   - 教授做了一场关于量子力学的正式讲座。
...
1. "I'm going on vacation for a fortnight."  
   **翻译**: "我要去度假两个星期。"

2. "The project will take a fortnight to complete."  
   **翻译**: "这个项目需要两个星期才能完成。"

3. "We haven't seen each other in a fortnight."  
   **翻译**: "我们有两个星期没见面了。"
...
### 列举例句
1. "She was fortunate to find a job so quickly after graduation."  
   **翻译**: "她很幸运，在毕业后这么快就找到了工作。"
   
2. "It was fortunate that we brought an umbrella, as it started raining heavily."  
   **翻译**: "我们很幸运带了伞，因为开始下大雨了。"
   
3. "He felt fortunate to have such supportive friends."  
...
2. **场景二：工作环境**
   - Fortunately, the project was completed on time despite the unexpected challenges.
   - 幸运的是，尽管遇到了意外的挑战，项目还是按时完成了。
...
2. **场景：时间**  
   - The meeting will start at forty minutes past two.  
   - 会议将在两点四十分开始。
...
1. The children were playing in the fountain on a hot summer day.  
   孩子们在炎热的夏日里在喷泉中玩耍。

2. The hotel had a beautiful fountain in its courtyard.  
   酒店的庭院里有一个美丽的喷泉。

3. She filled her water bottle at the public fountain.  
   她在公共饮水处装满了水瓶。
...
### 列举例句
1. **场景一：学校**
   - "There are fourteen students in our class."
   - "我们班有14个学生。"

2. **场景二：生日**
   - "She will be fourteen years old next week."
   - "她下周就满14岁了。"

3. **场景三：体育**
   - "The basketball team scored fourteen points in the first quarter."
   - "篮球队在第一节得了14分。"
...
1. **场景一：日常生活**
   - She only spent a fraction of her salary on clothes.
   - 她只花了工资的一小部分在衣服上。

2. **场景二：科学实验**
   - The scientist collected only a fraction of the data needed for the experiment.
   - 科学家只收集了实验所需数据的一小部分。

3. **场景三：数学**
   - The fraction 3/4 represents three parts out of four.
   - 分数3/4表示四分之三。
...
2. **场景二：工作场合**
   - "The manager gave a frank assessment of the project's progress."
   - “经理对项目的进展进行了坦率的评估。”

3. **场景三：个人表达**
   - "She was frank about her feelings and told him she loved him."
   - “她坦率地表达了自己的感情，并告诉他她爱他。”
...
3. **场景三：空闲**
   - "I have a free afternoon tomorrow; let's meet up."
   - "我明天下午有空，我们见面吧。"
...
### 列举例句
1. **场景一：政治讨论**  
   - "The fight for freedom is a universal human right."  
   - "争取自由是普遍的人权。"

2. **场景二：个人表达**  
   - "She enjoys the freedom to express her opinions openly."  
   - "她享受公开表达自己观点的自由。"

3. **场景三：日常生活**  
   - "After retirement, he finally found the freedom to travel."  
   - "退休后，他终于找到了旅行的自由。"
...
2. **场景**: 描述食物  
   We had a delicious French meal at the restaurant.  
   我们在餐厅享用了一顿美味的法式餐点。

3. **场景**: 描述文化  
   The French Revolution was a significant event in history.  
   法国大革命是历史上一个重要的事件。
...
### 列举例句
1. She is a frequent visitor to the library.  
   **翻译**: 她是图书馆的常客。
2. Frequent rain showers are expected this week.  
   **翻译**: 预计本周会有频繁的阵雨。
3. The restaurant is known for its frequent changes in menu.  
   **翻译**: 这家餐厅以其频繁更换菜单而闻名。
...
2. **场景二：空气**
   - The air by the sea is so fresh and clean.
   - 海边空气非常清新干净。

3. **场景三：想法**
   - She always comes up with fresh ideas for our projects.
   - 她总是能为我们的项目提出新颖的想法。
...
### 单词变形
- **名词形式**：freshness（新鲜度）。例如：The freshness of the fruit was noticeable.（水果的新鲜度很明显。）水果的新鲜度很明显。）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.）中文翻译:水果的新鲜度很明显.)
...
1. **场景：工作计划**
   - "We have a team meeting scheduled for Friday afternoon."
   - "我们安排了星期五下午的团队会议。"

2. **场景：周末计划**
   - "I'm planning to go hiking this Friday."
   - "我计划这个星期五去远足。"

3. **场景：宗教背景**
   - "In some cultures, Friday is considered an unlucky day."
   - "在一些文化中，星期五被认为是不吉利的一天。"
...
3. **场景三：宠物**  
   - My dog is very friendly and loves to play with other dogs.  
   - 我的狗非常友好，喜欢和其他狗一起玩耍。
...
1. "True friendship is built on trust and mutual respect."  
   **翻译**: 真正的友谊建立在信任和相互尊重的基础上。

2. "We have maintained a strong friendship for over twenty years."  
   **翻译**: 我们已经保持了超过二十年的深厚友谊。

3. "In times of difficulty, friendship is a source of strength."  
   **翻译**: 在困难时期，友谊是一种力量的源泉。
...
### 列举例句
1. **场景一：描述青蛙的外貌**  
   - The frog has a smooth, green skin and strong hind legs.  
   - 这只青蛙有着光滑的绿色皮肤和强壮的后腿。

2. **场景二：描述青蛙的行为**  
   - The frog jumped into the pond and started swimming.  
   - 青蛙跳进池塘开始游泳。

3. **场景三：童话故事中的青蛙**  
   - In the fairy tale, the frog turned into a prince after being kissed by a princess.  
   - 在童话故事中，被公主亲吻后，青蛙变成了王子。
...
1. **场景一：日常饮食**
   - "I bought a variety of fruits at the market today."
   - "我今天在市场买了各种各样的水果。"

2. **场景二：比喻用法**
   - "The research project yielded a rich fruit of knowledge."
   - "这个研究项目产生了丰富的知识成果。"

3. **场景三：烹饪**
   - "She used fresh fruits to make a delicious dessert."
   - "她用新鲜水果做了一道美味的甜点。"
...
2. **** The campfire needs more fuel to keep burning.  
   **翻译：** 营火需要更多的燃料来保持燃烧。

3. **** His passion for music fuels his creativity.  
   **翻译：** 他对音乐的热情激发了他的创造力。
...
1. **场景一：完成任务**
   - She fulfilled her duties as a teacher with great dedication.
   - 她以极大的奉献精神履行了作为教师的职责。
...
3. **场景三：满足需求**
   - The new policy aims to fulfil the needs of the elderly.
   - 新政策旨在满足老年人的需求。
...
3. **场景三：游戏**  
   - "Playing video games can be a lot of fun."  
   - “玩电子游戏可以非常有趣。”
...
### 列举例句
1. **场景一：家庭聚会**
   - The family held a small funeral at the local cemetery.
   - 这个家庭在当地公墓举行了一个小型葬礼。
   
2. **场景二：新闻报道**
   - The president attended the funeral of the war hero.
   - 总统参加了这位战争英雄的葬礼。
   
3. **场景三：宗教仪式**
   - A priest presided over the funeral service.
   - 一位牧师主持了葬礼仪式。
...
- **固定搭配**:  
   ...
   - *fur coat* (毛皮大衣)  
   穿毛皮、人造毛皮、毛皮大衣。
   动词形式：无直接动词变形；但可以通过组合形成动词短语如 *shed fur* (掉毛)。掉毛。   
   副词形式：无直接副词变形；但可以通过形容词 furry 形成副词 *furrily* (毛茸茸地)。毛茸茸地。   不同时态：无直接动词变形；但可以通过组合形成动词短语如 *shed fur* (掉毛)。掉毛。   不同时态：无直接动词变形；但可以通过组合形成动词短语如 *shed fur* (掉毛)。掉毛。   不同时态：无直接动词变形；但可以通过组合形成动词短语如 *shed fur* (掉毛)
...
- **固定搭配**:  
  ...
  - "electric furnace" (电炉)。  
  高炉、燃油炉、电炉。  
  组词：furnish, furniture, furnishing.  提供、家具、装饰品。  
...
1. **场景：个人规划**
   - "She is planning for her future career."
   - "她正在规划她的未来职业。"
