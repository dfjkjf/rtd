...
### 列举例句
1. "She added a handful of beans to the soup to make it more nutritious."  
   **翻译**: “她往汤里加了一把豆子，让它更有营养。”

2. "The farmer planted a field of beans this spring."  
   **翻译**: “这位农民今年春天种了一片豆子。”

3. "He ordered a plate of baked beans for breakfast."  
   **翻译**: “他早餐点了一份烤豆子。”
...
### 列举例句
1. **场景一：描述人**  
   - She was admired for her inner beauty as well as her outer beauty.  
   - 她不仅外表美丽，内在美也备受赞赏。

2. **场景二：描述自然**  
   - The beauty of the sunset over the ocean was breathtaking.  
   - 夕阳映照在海面上的美景令人叹为观止。

3. **场景三：艺术与文化**  
   - The beauty of this painting lies in its simplicity.  
   - 这幅画的美丽在于它的简洁。
...
2. **场景二：解释决定的原因**
   - She chose that book because she loves mysteries.
   - 她选择了那本书，因为她喜欢悬疑小说。
...
1. She wants to become a doctor when she grows up.  
   **翻译**: 她长大后想成为一名医生。
   
2. The weather is becoming colder as winter approaches.  
   **翻译**: 随着冬天的临近，天气变得越来越冷。
   
3. His dream finally became reality after years of hard work.  
...
### 列举例句
1. **场景一：家庭生活**
   - "She made her bed every morning before going to school."
   - "她每天早上上学前都会整理床铺。"
...
3. **场景三：户外活动**
   - "They slept on the ground using a sleeping bag as their bed."
   - "他们用睡袋睡在地上，当作他们的床。"
...
1. **场景：观察花园中的蜜蜂**
   - "The bee is collecting nectar from the flowers in the garden."
   - "蜜蜂正在花园里的花朵上采集花蜜。"

2. **场景：讨论蜂蜜的生产**
   - "Honey is produced by bees through a complex process."
   - "蜂蜜是通过蜜蜂的复杂过程生产的。"

3. **场景：描述蜜蜂的飞行**
   - "The bee's wings beat so fast that it's hard to see them."
   - "蜜蜂的翅膀拍动得如此之快，以至于很难看到它们。"
...
2. **场景：聚会**
   - "They brought a cooler full of beer to the party."
   - "他们带了一箱啤酒去参加聚会。"

3. **场景：餐厅**
   - "This restaurant has a great selection of craft beers."
   - "这家餐厅有很多手工啤酒可供选择。"
...
1. "She began her speech with a joke."  
   **翻译**: 她用一个笑话开始了她的演讲。
2. "It began to rain as we left the house."  
   **翻译**: 我们离开房子时开始下雨了。
3. "He began studying for the exam last week."  
   **翻译**: 他上周开始为考试学习。
...
- **固定搭配**:  
  - begin with: 以…开始  
    "The meeting began with a welcome speech."（会议以欢迎致辞开始。）  
- **组词**:  
...
- **组词**: behalf of（代表...的利益）  
- **其他变形**: None（无其他变形形式）  
- on behalf of（代表...）, in behalf of（为了...的利益）, behalf of（代表...的利益）  
...
2. **场景二：学校环境**
   - "The teacher asked the students to behave during the exam."
   - “老师要求学生在考试期间保持安静。”
...
### 列举例句
1. **场景一：学校**
   - The teacher was impressed by the students' behavior during the assembly.
   - 老师对学生在集会期间的行为印象深刻。

2. **场景二：动物园**
   - The zookeeper observed the unusual behavior of the lion after feeding.
   - 饲养员观察到狮子在喂食后的异常行为。

3. **场景三：工作场所**
   - His professional behavior in meetings has significantly improved.
   - 他在会议中的职业行为有了显著改善。
...
1. **场景一：宗教信仰**
   - "Her belief in God is unshakable."
   - 她对上帝的信仰是不可动摇的。

2. **场景二：个人信念**
   - "His belief in justice drives his career choice."
   - 他对正义的信念决定了他的职业选择。

3. **场景三：科学理论**
   - "Scientists have a belief that the universe began with a big bang."
   - 科学家们相信宇宙始于大爆炸。
...
3. **场景三：社会群体**
   - She belongs to a local charity organization.
   - 她属于一个当地的慈善组织。
...
1. **场景一：公园中的长凳**
   - She sat on the bench in the park, enjoying the sunshine.
   - 她坐在公园的长凳上，享受着阳光。

2. **场景二：体育比赛中的替补席**
   - The coach was sitting on the bench, watching the game closely.
   - 教练坐在替补席上，密切关注着比赛。

3. **场景三：实验室中的工作台**
   - The scientist carefully placed the chemicals on the bench before starting the experiment.
   - 科学家在开始实验前仔细地将化学品放在工作台上。
...
2. **场景二：建议**
   - "You should do your best in the exam."
   - “你应该在考试中尽你最大的努力。”
...
1. **场景一：体育比赛**
   - I bet on the home team to win the game.
   - 我押注主队会赢得比赛。

2. **场景二：日常对话**
   - He bet me $10 that I couldn't finish the race.
   - 他跟我打赌10美元，说我跑不完这场赛跑。

3. **场景三：金融投资**
   - The company placed a bet on new technology to increase profits.
   - 公司在新技术上下注以增加利润。
...
2. **场景二：建议或劝告**
   - You'd better study harder for the exam.
   - 你最好为考试更努力学习。
...
### 单词变形和固定搭配、组词及对应的无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：无变形和固定搭配如下：
...
- **名词**: Bible（单数）, Bibles（复数）。例如："He has many Bibles in his library."（他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》。）  他的图书馆里有很多本《圣经》
...
3. **场景三：环保意识**
   - "Using a bicycle reduces carbon emissions."
   - "使用自行车可以减少碳排放。"
...
- **副词形式**: (无)
- **固定搭配**: 
  1. **big deal**: 大事；重要的事  大事；重要的事  It's not a big deal, don't worry about it.（这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）  这不是什么大事，别担心。）
...
1. **场景一：金融**
   - The company reported a profit of over one billion dollars last year.
   - 该公司去年报告的利润超过十亿美元。

2. **场景二：科学**
   - Scientists estimate that there are over a billion stars in our galaxy.
   - 科学家估计我们银河系中有超过十亿颗星星。

3. **场景三：人口统计**
   - China has a population of over one billion people.
   - 中国的人口超过十亿。
...
### 列举例句
1. **场景一：日常生活中的捆绑**
   - She used a rope to bind the box securely.
   - 她用绳子把箱子牢牢地捆绑起来。

2. **场景二：法律或合同中的约束**
   - The contract binds both parties to the terms.
   - 合同使双方都受条款的约束。

3. **场景三：比喻性的结合**
   - Their shared experiences bound them together.
   - 他们共同的经历使他们紧密结合在一起。
...
1. She is passionate about biology and wants to become a biologist.  
   **翻译**: 她对生物学充满热情，想成为一名生物学家。

2. The biology class explored the different types of ecosystems.  
   **翻译**: 生物课探讨了不同类型的生态系统。

3. The biology textbook is very informative and covers a wide range of topics.  
...
### 列举例句
1. **场景一：自然观察**
   - "Look at that beautiful bird perched on the tree branch."
   - "看那只美丽的鸟停在树枝上。"

2. **场景二：宠物**
   - "My sister has a pet bird that can sing many songs."
   - "我妹妹有一只会唱很多歌的宠物鸟。"

3. **场景三：食物**
   - "We had roast bird for dinner last night."
   - "昨晚我们晚餐吃了烤鸟。"
...
### 列举例句
1. **场景一：庆祝生日**  
   - We are going to have a big party for her birthday.  
   - 我们打算为她举办一个盛大的生日派对。
...
3. **场景三：生日愿望**  
   - She made a wish before blowing out the candles on her birthday cake.  
   - 她在吹灭生日蛋糕上的蜡烛前许了个愿。
...
### 单词变形和固定搭配组词以及对应的无特殊变形或固定搭配组词。通常以名词形式出现。如需复数形式则为 birthdays (多个生日)。常见搭配包括：happy birthday (生日快乐), birthday cake (生日蛋糕), birthday party (生日派对)等。中文翻译分别为：生日快乐、生日蛋糕、生日派对等。记忆辅助提供一些高效的记忆技巧和窍门以更好地记住英文单词：可以将birthday与具体的场景联系起来记忆例如想象自己过生日的情景或者与朋友一起庆祝生日的画面这样可以帮助加深对单词的印象和理解同时也可以通过多次重复使用该单词来加强记忆效果小故事用英文撰写一个有画面感的场景故事包含用户提供的单词要求使用简单的词汇100个单词以内英文故事后面附带对应的It was Sarah's birthday today. She woke up early and found a big box at the foot of her bed. Inside the box was a beautiful dress. She put it on and went downstairs where her family was waiting for her with a big birthday cake. They sang "Happy Birthday" and she blew out the candles with a big smile. Later, they had a wonderful party with friends and lots of gifts. It was a perfect day!中文翻译今天是Sarah的生日她早早起床发现床尾有一个大盒子里面是一件漂亮的裙子她穿上裙子下楼看到家人正等着她面前摆着一个大大的生日蛋糕他们唱着“祝你生日快乐”她微笑着吹灭了蜡烛之后他们和朋友一起举办了一场精彩的派对收到了很多礼物这是一个完美的一天！
...
1. **场景一：工作场合**
   - "The manager blamed the team for the project delay."
   - "经理责备团队导致了项目延迟。"

2. **场景二：家庭环境**
   - "She blamed her brother for breaking the window."
   - "她责怪她哥哥打破了窗户。"

3. **场景三：交通事故**
   - "The police blamed the driver for the accident."
   - "警察认为司机应对事故负责。"
...
2. **场景2：表情**  
   - She had a blank expression on her face when she heard the news.  
   - 当她听到这个消息时，脸上露出茫然的表情。  
   
3. **场景3：思维**  
   - I stared at the question, my mind completely blank.  
   - 我盯着问题，脑子一片空白。  
   
4. **场景4：射击**（blank作为名词时还可以指“空包弹”）  
   - The actor fired a blank to simulate a gunshot.  
   - 演员发射了一颗空包弹来模拟枪声。
...
1. **场景一：家居使用**
   - She wrapped herself in a warm blanket after taking a shower.
   - 她洗完澡后用一条温暖的毯子裹住自己。

2. **场景二：比喻用法**
   - The new policy will provide a blanket of protection for all citizens.
   - 新政策将为所有公民提供全面的保护。

3. **场景三：户外活动**
   - They brought a blanket to sit on during the outdoor concert.
   - 他们在户外音乐会上带了一条毯子来坐。
...
1. **场景一：医疗**
   - The soldier was bleeding heavily from his wound.
   - 士兵的伤口大量出血。

2. **场景二：财务**
   - The company is bleeding money due to the new project.
   - 由于新项目，公司正在大量耗费资金。

3. **场景三：情感**
   - She felt like her heart was bleeding after the breakup.
   - 分手后，她感觉心在滴血。
...
- blend (混合), blend in (融入), blend with (与...混合)  
...
### 列举例句
1. **场景一：娱乐**  
   - We rented a boat and went fishing on the lake.  
   - 我们租了一条船，去湖上钓鱼。

2. **场景二：运输**  
   - The ferry is a large boat that carries cars and passengers across the river.  
   - 渡轮是一种大型船只，可以在河上运送汽车和乘客。

3. **场景三：紧急情况**  
   - The rescue team used a small boat to save the people trapped in the flood.  
   - 救援队用一艘小船救出了被困在洪水中的人们。
...
1. **场景一：健康**
   - "Taking care of your body is essential for good health."
   - "照顾好你的身体对健康至关重要。"
...
3. **场景三：法律**
   - "The legal body has issued a new regulation."
   - "这个法律机构发布了一项新规定。"
...
1. **场景一：描述个人性格**
   ...
   - 她做了一个大胆的决定，辞掉工作开始自己的生意。
   
2. **场景二：描述设计风格**
   - The logo has a bold design that stands out on the billboard.
   - 这个标志有一个大胆的设计，在广告牌上非常显眼。
   
3. **场景三：描述行为**
   - He was bold enough to speak up in front of the whole company.
   - 他大胆地在全公司面前发言。
...
1. **情感纽带**：  
   ...
   - **翻译**: "母子之间的纽带是牢不可破的。"
2. **金融债券**：  
   - "He invested in government bonds to secure his retirement."  
   - **翻译**: "他投资了政府债券以确保退休后的生活。"
3. **化学结合**：  
   - "The hydrogen and oxygen bonded to form water."  
   - **翻译**: "氢和氧结合形成了水。"
...
2. **场景：烹饪**
   - She cooked the soup with chicken bones for extra flavor.
   - 她用鸡骨头煮汤以增加风味。

3. **场景：医学**
   - The doctor examined the X-ray to check for any bone fractures.
   - 医生检查了X光片，查看是否有骨折。
...
2. **场景二：工作环境**
   - The construction workers bored a hole in the wall to install a new pipe.
   - 建筑工人在墙上钻了一个孔来安装新管道。
   
3. **场景三：社交场合**
   - She is such a bore; she talks about the same topic every time we meet.
   - 她真是个无聊的人；每次见面她都谈论同一个话题。
...
3. **场景三：金融借贷**
   - "She had to borrow money to pay for her education."  
   - "她不得不借钱来支付她的教育费用。"
...
2. **场景二：情感表达**
   - "It doesn't bother me if you come late."
   - “你来晚了我不介意。”

3. **场景三：工作环境**
   - "Don't bother the manager while he's in a meeting."
   - “经理在开会时不要打扰他。”
...
1. **** She filled the bottle with fresh water from the spring.  
   **** 她用泉水装满了瓶子。

2. **** He accidentally dropped the bottle and it shattered into pieces.  
   **** 他不小心把瓶子掉在地上，摔成了碎片。

3. **** The wine was stored in a dark bottle to preserve its flavor.  
   **** 葡萄酒被存放在深色瓶子里以保持其风味。
...
2. **场景二：体育运动**
   - He picked up his bowling bowl and prepared to throw.
   - 他拿起他的保龄球准备投掷。

3. **场景三：自然景观**
   - The valley looked like a giant bowl filled with green trees.
   - 山谷看起来像一个装满绿色树木的巨大碗。
...
### 列举例句
1. **场景一：家庭**
   - "My little boy loves to play soccer."
   - "我的小男孩喜欢踢足球。"
...
3. **场景三：公共场所**
   - "A group of boys were playing in the park."
   - "一群男孩在公园里玩耍。"
...
1. **场景一：驾驶**
   - "He applied the brake to slow down the car."
   - "他踩下刹车使汽车减速。"
   
2. **场景二：自行车**
   - "She accidentally pressed the brake too hard and fell off her bike."
   - "她不小心用力过猛地按下了刹车，结果从自行车上摔了下来。"
   
3. **场景三：机械设备**
   - "The emergency brake on the elevator stopped it immediately."
   - "电梯的紧急制动器立即让它停了下来。"
...
### 列举例句
1. **场景一：面对危险**
   - She was brave enough to confront the bear.
   - 她勇敢地面对了那只熊。

2. **场景二：克服恐惧**
   - He showed great bravery during the surgery.
   - 他在手术期间表现出了极大的勇气。
...
1. **场景一：家庭早餐**
   - We usually have breakfast together as a family.
   - 我们通常全家人一起吃早餐。

2. **场景二：酒店早餐**
   - The hotel offers a buffet breakfast from 7 to 10 am.
   - 这家酒店提供从早上7点到10点的自助早餐。
...
### 列举例句
1. **场景一：人体部位**
   - She covered her breast with her hands for modesty.
   - 她用手遮住胸部以示端庄。
   
2. **场景二：烹饪**
   - The chef prepared a delicious dish using chicken breast.
   - 厨师用鸡胸肉做了一道美味的菜肴。
   
3. **场景三：情感表达**
   - He held his baby to his breast, feeling the warmth of the moment.
   - 他把宝宝抱在胸前，感受着这一刻的温暖。
...
3. **场景三：象征生命或精神**
   - "The doctor managed to restore the patient's breath."
   - "医生设法恢复了病人的呼吸。"
...
1. **场景一：日常生活中的呼吸**
   - "Please remember to breathe deeply when you feel stressed."
   - "当你感到压力时，请记得深呼吸。"

2. **场景二：运动中的呼吸**
   - "He was told to breathe in through the nose and out through the mouth during yoga."
   - "在做瑜伽时，他被告知通过鼻子吸气，通过嘴巴呼气。"

3. **场景三：紧急情况下的呼吸**
   - "The paramedic checked to see if the patient was still breathing."
   - "急救人员检查病人是否还在呼吸。"
...
- brightness - 亮度；brightly - 明亮地；brighten - 使变亮；brighter - 更明亮的；brightest - 最明亮的；bright idea - 好主意；bright future - 光明的未来；brighten up - 使变亮/高兴起来。
...
### 列举例句
1. **场景一：描述人的智力**
   - She gave a brilliant presentation at the conference.
   - 她在会议上做了一个非常精彩的演讲。
...
3. **场景三：描述成就**
   - His brilliant achievement in science earned him a Nobel Prize.
   - 他在科学上的卓越成就为他赢得了诺贝尔奖。
...
- 光辉；才华；出色地；灿烂地；绝妙的主意；出色的表演；聪慧的头脑。
...
- **固定搭配**:  
  ...
  - "bring forward"（提前；提出）  
    ...
    你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？）   你能把会议提前一小时吗？
...
### 列举例句
1. **场景**: 描述国籍  
   She is British, born and raised in London.  
   她是英国人，出生并成长于伦敦。

2. **场景**: 描述文化  
   The British Museum is famous for its vast collection of artifacts.  
   大英博物馆以其丰富的文物收藏而闻名。

3. **场景**: 描述语言  
   British English and American English have some differences in spelling and pronunciation.  
   英式英语和美式英语在拼写和发音上有一些差异。
...
2. **场景二：科学实验**
   - When you mix baking soda and vinegar, it creates bubbles.
   - 当你把小苏打和醋混合时，会产生气泡。
   
3. **场景三：经济现象**
   - The housing market bubble finally burst, causing a financial crisis.
   - 房地产市场泡沫最终破裂，引发了金融危机。
...
3. **场景三：娱乐活动**
   - "We had a lot of fun at the beach, playing with a bucket and spade."
   - "我们在海滩上玩得很开心，用桶和铲子玩沙子。"
...
1. They are planning to build a new school in the village.  
   **翻译**: 他们计划在村里建一所新学校。

2. The company is working on building a strong brand image.  
   **翻译**: 公司正在努力打造一个强大的品牌形象。

3. She built her career from scratch.  
   **翻译**: 她从零开始建立了自己的事业。
...
### 列举例句
1. **场景一：家庭生活**
   - "Remember to replace the burnt-out bulb in the living room."
   - “记得更换客厅里烧坏的灯泡。”

2. **场景二：园艺**
   - "She planted tulip bulbs in her garden last autumn."
   - “去年秋天她在花园里种了郁金香球茎。”

3. **场景三：科学实验**
   - "The scientist used a light bulb to demonstrate the principles of electricity."
   - “科学家用一个灯泡来演示电的原理。”
...
2. **场景二：商业环境中的使用**
   - The company decided to bundle their software with hardware.
   - 公司决定将软件与硬件打包销售。
   
3. **场景三：紧急情况下的使用**
   - He quickly bundled up his belongings and left the house.
   - 他迅速收拾好行李离开了房子。
...
1. **场景一：家具**
   - "She organized her papers on the bureau before starting her work."
   - "她在开始工作前把文件整理在办公桌上。"
...
3. **场景三：信息服务**
   - "The travel bureau provided us with all the information we needed for our trip."
   - "旅行社为我们提供了旅行所需的所有信息。"
...
- He burst into laughter. / 他突然大笑起来。
...
孩子在玩气球。突然，气球发出一声巨响爆裂了。孩子吓了一跳，但很快就开始笑了起来。爆裂的气球不再是问题；它只是有趣！
...
2. **场景二：旅游**  
   - "We booked a sightseeing bus tour for our vacation."  
   - "我们为假期预订了一次观光巴士之旅。"
...
2. **场景二：描述工作环境**
   - The office is always busy on Monday mornings.
   - 周一早上办公室总是很忙。
   
3. **场景三：描述设备使用情况**
   - The phone line is busy; please try again later.
   - 电话线路正忙，请稍后再试。
...
2. **场景二：烹饪**  
   - "She melted butter in a pan before adding the vegetables."  
   - "她在加入蔬菜之前先把黄油融化在锅里。"

3. **场景三：描述食物**  
   - "The cake was rich and moist, with a generous amount of butter."  
   - "蛋糕非常丰富湿润，含有大量的黄油。"
...
- **动词形式**: butter (涂黄油)  
  - "She buttered the bread before serving it." (她在上菜前给面包涂了黄油。)  
- **固定搭配**:  
  - **bread and butter** (生计；基本生活来源)  
    - "Teaching is his bread and butter." (教书是他的生计。)  
  - **butter up** (讨好；奉承)  
    - "He tried to butter up his boss by complimenting her work." (他试图通过赞美老板的工作来讨好她。)  
...
1. **表示位置或方向**：靠近、在...旁边。
   - The cat is sitting by the window. (猫坐在窗边。)
   
2. **表示时间**：在...之前、不迟于。
   - I will finish my homework by 5 PM. (我会在下午5点前完成作业。)
   
3. **表示手段或方法**：通过、用。
   - She sent the letter by mail. (她通过邮寄寄出了信。)
   
4. **表示作者或来源**：由、被。
   - The book was written by Mark Twain. (这本书是由马克·吐温写的。)
   
5. **表示标准或单位**：以...为单位。
   - The car can go 60 miles by hour. (这辆车每小时能行驶60英里。)
