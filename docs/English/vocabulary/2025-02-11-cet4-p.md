...
1. **场景一：社交聚会**
   - We had a big party last night to celebrate my birthday.
   - 昨晚我们举办了一个盛大的派对来庆祝我的生日。

2. **场景二：政治党派**
   - The Democratic Party is one of the major political parties in the United States.
   - 民主党是美国的主要政党之一。

3. **场景三：法律上的“一方”**
   - Both parties in the contract must agree to the terms before it is signed.
   - 合同双方必须在签署前同意条款。
...
1. **场景一：飞机**
   - The flight attendant helped the elderly passenger to find his seat.
   - 空乘人员帮助那位老年乘客找到了他的座位。
...
3. **场景三：出租车**
   - The taxi driver dropped off the passenger at the airport.
   - 出租车司机把乘客送到了机场。
...
### 列举例句
1. **场景：工作环境**  
   - "He adopted a passive attitude during the meeting."  
   - 他在会议中采取了被动的态度。

2. **场景：学习**  
   - "She has a passive approach to learning new languages."  
   - 她在学习新语言时采取了一种被动的方法。

3. **场景：人际关系**  
   - "In the relationship, he was often passive and let her make all the decisions."  
   - 在这段关系中，他经常处于被动状态，让她做出所有决定。
...
3. **场景三：友好**
   - He gave his friend a pat on the shoulder during the conversation.
   - 在谈话中他轻轻拍了拍朋友的肩膀。
...
### 列举例句
1. **场景一：日常对话**
   - "She paused to take a deep breath before continuing her speech."
   - "她在继续演讲前停顿了一下，深吸了一口气。"
...
3. **场景三：工作流程**
   - "The project will be in pause until we receive further instructions."
   - "在收到进一步指示之前，项目将处于暂停状态。"
...
- 支付, 工资, 薪水支票, 工资单, 注意, 偿还, 偿清, 为...付款, ...可支付的,...可支付地,...可偿还的,...可偿清的,...为...付款的,...注意的,...偿还的,...偿清的,...工资单的,...薪水支票的,...支付的,...工资的,...薪水的,...支票的,...单据的,...票据的,...凭证的,...证明的,...证据的,...凭据的,...凭单的,...凭条的,...凭信的,...凭票的,...,凭据,...,凭条,...,凭信,...,凭票,...,凭单,...,凭条,...,凭信,...,凭票,...,凭单,...,凭条,...,凭信,...,凭票,...,凭单,...,凭条,...,凭信,...,凭票,...,凭单,...,凭条,...,
...
1. "I added some peas to my salad for extra nutrition."  
   **翻译**: "我在沙拉里加了一些豌豆，以增加营养。"
   
2. "The baby loves to eat mashed peas."  
   **翻译**: "宝宝喜欢吃捣碎的豌豆。"
   
3. "We had peas and carrots as a side dish with our dinner."  
   **翻译**: "我们晚餐时用豌豆和胡萝卜作为配菜。"
...
1. **场景一：水果店**
   - "I bought a peach at the market today. It was so juicy and sweet!"
   - "今天我在市场买了一个桃子。它非常多汁且甜美！"

2. **场景二：形容人**
   - "She is a real peach; everyone loves her."
   - "她真是个好人；大家都喜欢她。"

3. **场景三：形容事物**
   - "This new phone is a peach; it has all the features I need."
   - "这款新手机真是太棒了；它具备我需要的所有功能。"
...
3. **场景三：表达意见**
   - "It's important to speak up when you have a different opinion."
   - “当你有不同意见时，重要的是要大胆说出来。”
...
### 列举例句
1. **场景一：描述水果**
   - "I bought a ripe pear from the market."
   - "我从市场买了一个成熟的梨。"

2. **场景二：饮食习惯**
   - "She prefers pears over apples."
   - "她比起苹果更喜欢梨。"

3. **场景三：烹饪用途**
   - "We made a delicious pear pie for dessert."
   - "我们为甜点做了一个美味的梨派。"
...
2. **场景二：社会群体**
   - "The people of this village are very friendly."
   - "这个村庄的人们非常友好。"
   
3. **场景三：政治语境**
   - "The government should listen to the people's voices."
   - "政府应该倾听人民的声音。"
...
### 列举例句
1. "The car can travel 20 miles per gallon."  
   **翻译**: "这辆车每加仑油可以行驶20英里。"  
2. "She earns $50 per hour."  
   **翻译**: "她每小时赚50美元。"  
3. "The cake recipe calls for one egg per person."  
   **翻译**: "蛋糕的食谱要求每人一个鸡蛋。"
...
1. **场景一：日常感知**
   - She quickly perceived the change in his behavior.
   - 她很快察觉到他行为的变化。

2. **场景二：学术理解**
   - Students often perceive math as a difficult subject.
   - 学生们通常认为数学是一门难学的科目。

3. **场景三：艺术欣赏**
   - The audience easily perceived the underlying message in the painting.
   - 观众很容易理解画中隐藏的信息。
...
### 列举例句
1. **场景一：日常对话**
   - "Perhaps we should go to the park this afternoon."
   - "也许我们今天下午应该去公园。"
   
2. **场景二：建议**
   - "Perhaps you could try calling them again later."
   - "也许你可以稍后再给他们打电话。"
...
1. **场景一：工作**
   - She got a permanent position at the company after her internship.
   - 她在实习后在公司获得了永久职位。

2. **场景二：纹身**
   - He decided to get a permanent tattoo of his daughter's name.
   - 他决定纹一个永久性的女儿名字的纹身。

3. **场景三：记忆**
   - The experience left a permanent mark on her memory.
   - 这次经历在她的记忆中留下了永久的印记。
...
2. **场景二：工作环境**
   - "The manager will not permit late arrivals."
   - "经理不允许迟到。"
...
2. **场景二：工作环境**  
   - "She made a personal call during the meeting."  
   - "她在会议期间接了一个私人电话。"

3. **场景三：社交媒体**  
   - "Do not share personal photos on social media without permission."  
   - "未经允许，请勿在社交媒体上分享私人照片。"
...
- **名词**: persuasion（说服）, persuasive（有说服力的）, persuader（说服者）.  说服,有说服力的,说服者.  复数形式: persuasions, persuaders.  动词: persuades, persuading, persuaded.  不同时态: persuades (现在时), persuaded (过去时), persuading (进行时).  形容词: persuasive (有说服力的).  副词: persuasively (有说服力地).  固定搭配: persuade someone to do something (说服某人做某事), be persuaded by (被...所说服).  组词: persuasive argument (有说服力的论点), persuasive speech (有说服力的演讲).有说服力的论点,有说服力的演讲.记忆辅助提供一些高效的记忆技巧和窍门以更好地记住英文单词.小故事用英文撰写一个有画面感的场景故事包含用户提供的单词要求使用简单的词汇100个单词以内英文故事后面附带对应的中文翻译."Persuade".
...
1. **场景一：工作环境**
   - "After hearing the bad news, he became pessimistic about the company's future."
   - "听到这个坏消息后，他对公司的未来变得悲观。"
...
3. **场景三：社会问题**
   - "The economist is pessimistic about the country's economic recovery."
   - "经济学家对该国的经济复苏感到悲观。"
...
1. My little sister has a pet rabbit named Fluffy.  
   **翻译**: 我的小妹妹有一只名叫Fluffy的宠物兔子。
   
2. She loves to pet her cat every evening before bedtime.  
   **翻译**: 她喜欢每晚睡觉前抚摸她的猫。
   
3. The children were excited to see the petting zoo at the fair.  
...
2. **场景：讨论燃料价格**
   - "The price of petrol has increased significantly this year."
   - "今年汽油的价格显著上涨了。"

3. **场景：环保讨论**
   - "Using electric cars can reduce our reliance on petrol."
   - "使用电动汽车可以减少我们对汽油的依赖。"
...
1. **场景一：工业生产**  
   - Petroleum is a crucial resource for manufacturing plastics and chemicals.  
   - 石油是制造塑料和化学品的重要资源。

2. **场景二：能源供应**  
   - The country relies heavily on petroleum imports to meet its energy needs.  
   - 该国严重依赖石油进口来满足其能源需求。

3. **场景三：环境保护**  
   - Environmentalists are concerned about the impact of petroleum extraction on ecosystems.  
   - 环保主义者担心石油开采对生态系统的影响。
...
### 单词变形
- **名词形式**: photo, photos（复数）。照片，多张照片。
- **动词形式**: photograph, photographed, photographing.拍照，被拍照，正在拍照。
- **形容词形式**: photographic.摄影的，照相的。
- **固定搭配**: take a photo, photoshoot, photo album.拍一张照片，拍摄活动，相册。
...
### 列举例句
1. **场景一：健康**
   - Regular exercise is important for your physical health.
   - 定期锻炼对你的身体健康很重要。
...
3. **场景三：物理现象**
   - The physical properties of water include its ability to dissolve many substances.
   - 水的物理性质包括其溶解多种物质的能力。
...
1. **场景一：医院**
   - The physician examined the patient thoroughly before prescribing any medication.
   - 医生在开药之前对病人进行了彻底的检查。

2. **场景二：健康咨询**
   - She sought advice from a physician about her chronic back pain.
   - 她向一位内科医生咨询了她慢性背痛的问题。

3. **场景三：职业描述**
   - Becoming a physician requires years of rigorous training and education.
   - 成为一名内科医生需要多年的严格培训和教育。
...
2. **场景**: 描述一个人对物理学的兴趣。
   - She has a great interest in physics and wants to become a physicist.
   - 她对物理学有浓厚的兴趣，并希望成为一名物理学家。
   
3. **场景**: 讨论物理学在日常生活中的应用。
   - The principles of physics are applied in many everyday devices, such as smartphones and cars.
   - 物理学的原理应用于许多日常设备，如智能手机和汽车。
...
1. **场景一：学习音乐**
   - She started learning the piano when she was five years old.
   - 她五岁时开始学习钢琴。
...
3. **场景三：家庭娱乐**
   - We have a small piano in our living room for family entertainment.
   - 我们在客厅里有一架小钢琴，用于家庭娱乐。
...
1. **场景一：家庭聚会**
   - Our family loves to have a picnic in the park on weekends.
   - 我们家喜欢在周末去公园野餐。

2. **场景二：学校活动**
   - The school organized a picnic for the students to enjoy nature.
   - 学校为学生们组织了一次野餐，让他们享受大自然。

3. **场景三：情侣约会**
   - They decided to have a romantic picnic by the lake.
   - 他们决定在湖边进行一次浪漫的野餐。
...
1. **场景一：家庭聚会**
   - We baked an apple pie for the family gathering.
   - 我们为家庭聚会烤了一个苹果派。

2. **场景二：餐厅点餐**
   - I ordered a cherry pie for dessert at the restaurant.
   - 我在餐厅点了樱桃派作为甜点。

3. **场景三：节日庆祝**
   - On Thanksgiving, we always have pumpkin pie as a tradition.
   - 在感恩节，我们总是有南瓜派作为传统。
...
2. **片段**：
   - He played a piece of classical music on the piano.  
   - 他在钢琴上演奏了一段古典音乐。
   
3. **硬币**：
   - He dropped a piece of silver on the counter.  
   - 他把一枚银币放在柜台上。
   
4. **棋子**：
   - The knight moved two squares forward and one piece to the side.  
   - 马向前移动了两格，向旁边移动了一格。
...
2. **场景二：饮食**  
   - We had roast pig for dinner last night.  
   - 昨晚我们晚餐吃了烤猪肉。

3. **场景三：宠物**  
   - My cousin has a pet pig named Lulu.  
   - 我表弟有一只名叫露露的宠物猪。
...
### 列举例句
1. **场景一：城市中的鸽子**
   - The park was filled with pigeons, pecking at crumbs left by passersby.
   - 公园里到处都是鸽子，啄食着路人留下的面包屑。

2. **场景二：信鸽的历史用途**
   - During World War I, pigeons were used to carry messages across enemy lines.
   - 在一战期间，鸽子被用来在敌线之间传递信息。

3. **场景三：和平的象征**
   - The dove, a symbol of peace, is often confused with the common pigeon.
   - 作为和平象征的鸽子，常常被误认为是普通的鸽子。
...
2. **场景二：建筑工地**
   - The workers piled the bricks on the side of the road.
   - 工人们把砖块堆放在路边。
   
3. **场景三：财务管理**
   - He sorted through the pile of invoices to find the one he needed.
   - 他在一堆发票中翻找他需要的那一张。
...
2. **场景二：医生建议**
   - The doctor prescribed a new pill for her high blood pressure.
   - 医生为她开了新药来治疗高血压。

3. **场景三：药物副作用**
   - He experienced nausea after taking the pill.
   - 他服药后感到恶心。
...
2. **场景二：旅行**
   - I always bring my own pillow when I travel.
   - 我旅行时总是带上自己的枕头。
   
3. **场景三：儿童房**
   - The child hugged her favorite stuffed animal pillow tightly.
   - 孩子紧紧抱着她最喜欢的毛绒动物枕头。
...
1. **场景一：航空**
   ...
   - 尽管天气恶劣，飞行员还是安全地将飞机降落了。
   
2. **场景二：项目管理**
   - She was hired to pilot the new marketing campaign.
   - 她被雇佣来引导新的市场营销活动。
   
3. **场景三：航海**
   - The captain asked the pilot to guide the ship through the narrow channel.
   - 船长请引航员引导船只通过狭窄的航道。
...
安全别针, 图钉, 图钉  固定搭配的中文翻译分别为确定、钉住、使某人无法动弹。组词的中文翻译为安全别针、图钉、图钉。
...
1. **场景一：酒吧**
   - "The bartender poured me a pint of ale."
   - "酒保给我倒了一品脱的麦芽酒。"
...
3. **场景三：体育赛事**
   - "After the match, we all had a pint at the local pub."
   - "比赛结束后，我们都在当地的酒吧喝了一品脱。"
...
1. **场景一：日常生活中的位置**
   - "I left my keys in the usual place."
   - "我把钥匙放在了平常的地方。"
   
2. **场景二：安排或安置某人**
   - "The teacher placed the student in the front row."
   - "老师把学生安排在前排。"
...
### 列举例句
1. **场景：描述食物**  
   - She prefers plain food without any spices.  
   - 她更喜欢不加任何调料的简单食物。
...
3. **场景：描述表达**  
   - He spoke in plain English so everyone could understand.  
   - 他用简单的英语说话，以便每个人都能理解。
...
1. **场景一：日常计划**
   - "I need to make a plan for my weekend."
   - "我需要为我的周末制定一个计划。"
   
2. **场景二：商业策略**
   - "The company has a five-year plan to expand its market."
   - "公司有一个五年计划来扩展市场。"
   
3. **场景三：旅行安排**
   - "We planned our trip to Europe carefully."
   - "我们仔细规划了我们的欧洲之旅。"
...
- **相同词缀的单词**: 例如，“planned”可以与其他动词结合形成形容词，如“organized”（有组织的）、“prepared”（准备好的）等。
   - "organize" + "-ed" = "organized"（有组织的）；有组织的；组织好的；组织过的；组织得很好的；组织得很好的东西；组织得很好的事情；组织得很好的活动；组织得很好的会议；组织得很好的聚会；组织得很好的活动场所；组织得很好的活动场所的布置；组织得很好的活动场所的布置方式；组织得很好的活动场所的布置方式的改进；组织得很好的活动场所的布置方式的改进措施；组织得很好的活动场所的布置方式的改进措施的实施；组织得很好的活动场所的布置方式的改进措施的实施效果；组织得很好的活动场所的布置方式的改进措施的实施效果评估；组织得很好的活动场所的布置方式的改进措施的实施效果评估报告；组织得很好的活动场所的布置方式的改进措施的实施效果评估报告的内容；组织得很好的活动场所的布置方式的改进措施的实施效果评估报告的内容分析；组织得很好的活动场所
...
2. **场景二：艺术与设计**
   - "The artist used plastic to create a sculpture."  
   - “艺术家用塑料制作了一座雕塑。”
   
3. **场景三：医学**
   - "The surgeon used a plastic plate to repair the broken bone."  
   - “外科医生用一块塑料板来修复骨折。”
...
2. **场景二：公园**
   - There is a new playground in the park, which attracts many kids on weekends.
   - 公园里有一个新操场，周末吸引了许多孩子。

3. **场景三：比喻**
   - The startup company is like a playground for young entrepreneurs to test their ideas.
   - 这家初创公司就像一个供年轻企业家测试想法的操场。
...
### 单词变形
- **形容词**: pleasant（愉快的）  
- **副词**: pleasantly（愉快地）  【She smiled pleasantly at the guests.】（她愉快地对客人们微笑）。  
- **名词形式**: pleasure（快乐）【It's a pleasure to meet you.】（很高兴见到你）。  
- **固定搭配**:  
  - a pleasant surprise（一个愉快的惊喜）【The party was a pleasant surprise for everyone.】（派对对每个人来说都是一个愉快的惊喜）。  
  - make someone's day pleasant（让某人心情愉快）【Your kind words made my day pleasant.】（你的善意话语让我心情愉快了一整天）。  
- **反义词**: unpleasant（不愉快的）【The weather was unpleasant due to heavy rain.】（由于大雨，天气很不舒服）。  
- **同义词**: enjoyable, agreeable, nice, pleasing, delightful.   【The movie was enjoyable/agreeable/nice/pleasing/delightful.】（这部电影很有趣/令人愉快/不错/令人愉悦/令人愉悦的）。   【这部电影很有趣/令人愉快/不错/令人愉悦/令人愉悦的）】   【注释：这些同义词在程度上略有不同，但都表示愉快的感觉】   【注释2：enjoyable更强调通过参与活动获得的乐趣；agreeable更强调符合个人喜好；nice是常用口语表达；pleasing强调令人满意的；delightful则带有更强烈的喜悦感】   【注释3：以上所有同义词都可以替换使用在不同语境中以避免重复单调乏味之感】   【注释4：在使用时可以根据具体语境选择最合适的词汇以达到最佳表达效果】   【注释5：例如在正式场合或者书面语中可以使用agreeable或者pleasing以显得更加正式得体；而在非正式场合或者口语中则可以使用nice或者enjoyable以显得更加随意自然亲切友好等等】   【注释6：总之在使用时要根据具体情况灵活选择最合适的词汇以达到最佳表达效果并避免重复单调乏味之感等等问题发生影响整体表达效果以及沟通交流质量等等方面考虑因素综合权衡利弊得失之后做出最佳选择方案决定行动计划实施步骤执行过程监控反馈调整优化改进提升完善提高整体水平质量效率效益效果影响力竞争力发展潜力空间前景展望未来趋势走向预测分析判断决策制定执行落实到位见成效出成果达目标创佳绩立新功开新局谱新篇绘蓝图谋新篇展宏图创伟业建功勋立新功开新局谱新篇绘蓝图谋新篇展宏图创伟业建功勋立新功开新局谱新篇绘蓝图谋新篇展宏图创伟业建功勋立新功开新局谱新篇绘蓝图谋新篇展宏图创伟业建功勋立新功开新局谱
...
1. "There is plenty of food at the party."  
   **翻译**: “派对上有充足的食物。”

2. "She has plenty of time to finish her homework."  
   **翻译**: “她有足够的时间完成作业。”

3. "The garden has plenty of flowers in the spring."  
   **翻译**: “春天花园里有大量的花。”
...
2. **场景二：经济变化**
   - The stock market plunged after the news of the economic crisis.
   - 经济危机的消息传出后，股市暴跌。

3. **场景三：情感变化**
   - She plunged into despair after hearing the bad news.
   - 听到坏消息后，她陷入了绝望。
...
“我在街上捡到一个钱包。里面有一些钱，还有一张家庭照片。我决定把它还给失主。”
...
1. "The poet wrote a beautiful sonnet about love."  
   **翻译**: "这位诗人写了一首关于爱情的美丽十四行诗。"
   
2. "She admired the poet's ability to convey deep emotions through simple words."  
   **翻译**: "她钦佩这位诗人用简单的词语表达深厚情感的能力。"
   
3. "The poet's latest collection of poems has received critical acclaim."  
...
1. **场景一：数学中的点**
   - The teacher pointed to a specific point on the graph.
   - 老师指着图表上的一个特定点。
...
3. **场景三：方向指引**
   - He pointed at the map to show us the way to the museum.
   - 他指着地图给我们指出去博物馆的路。
...
1. **场景一：健康与安全**
   - "The scientist warned us about the dangers of the poison."
   - “科学家警告我们这种毒药的危险性。”
   
2. **场景二：犯罪与侦探**
   - "The detective discovered that the victim had been poisoned."
   - “侦探发现受害者被下了毒。”
   
3. **场景三：自然与环境**
   - "Some plants produce a poison that can harm animals."
   - “一些植物会产生能伤害动物的毒素。”
...
4. **场景四：运动**  
   - He used the pole to vault over the bar.  
   - 他用撑杆跳过了横杆。
...
1. **场景**: 在学校门口，家长与警察交流。
   - The policeman helped the children cross the street safely.
   - 警察帮助孩子们安全地过马路。

2. **场景**: 在犯罪现场，警察调查案件。
   - The policeman was investigating the robbery that happened last night.
   - 警察正在调查昨晚发生的抢劫案。

3. **场景**: 在社区活动中，警察维持秩序。
   - The policeman ensured that the parade went smoothly without any incidents.
   - 警察确保游行顺利进行，没有发生任何事故。
...
1. **场景一：人口统计**
   - The population of this city has increased by 20% over the past decade.
   - 这座城市的人口在过去十年中增长了20%。

2. **场景二：生态学**
   - The population of deer in this forest is declining due to habitat loss.
   - 由于栖息地的丧失，这片森林中鹿的数量正在减少。

3. **场景三：经济学**
   - A larger population often leads to higher demand for goods and services.
   - 人口越多，往往会导致对商品和服务的需求增加。
...
1. "I cooked some pork chops for dinner tonight."  
   **翻译**: "今晚我做了一些猪排当晚餐。"
2. "The restaurant is famous for its crispy pork belly."  
   **翻译**: "这家餐厅以其脆皮五花肉而闻名。"
3. "Pork is a staple in many Asian cuisines."  
   **翻译**: "猪肉是许多亚洲菜肴的主食。"
...
1. **场景一：物理位置**
   - "The chair was in a comfortable position near the window."
   - "椅子被放在窗户旁边一个舒适的位置。"
...
3. **场景三：观点或立场**
   - "He took a firm position on the issue of climate change."
   - "他在气候变化问题上立场坚定。"
...
2. **场景二：肯定与确认**  
   - The test results came back positive for the disease.  
   - **翻译**: 检测结果显示对这种疾病呈阳性。
...
4. **场景四：科学领域**  
   - The positive charge of the proton attracts the negative charge of the electron.  
   - **翻译**: 质子的正电荷吸引电子的负电荷。
   
5. **场景五：个人发展**  
   - Reading positive books can help improve your mindset.  
...
2. **场景二：工作场合**
   - "We are exploring the possibility of expanding our business to Asia."
   - "我们正在探讨将业务扩展到亚洲的可能性。"

3. **场景三：学术讨论**
   - "The possibility of finding a cure for this disease is very low."
   - "找到这种疾病治疗方法的可能性非常低。"
...
2. **场景二：工作环境**
   - "We need to find a possible solution to this problem."
   - "我们需要找到一个可能的解决方案来解决这个问题。"

3. **场景三：学习**
   - "It's possible that I might fail the exam, but I'll try my best."
   - "我可能会考试不及格，但我会尽我最大的努力。"
...
1. The meeting has been postponed until next Monday.  
   **翻译**: 会议已经推迟到下周一。
2. She decided to postpone her vacation due to the unexpected work load.  
   **翻译**: 由于意外的工作量，她决定推迟她的假期。
3. The concert was postponed because of the heavy rain.  
   **翻译**: 由于大雨，音乐会被推迟了。
...
2. **场景二：商业机会**
   - The new market has great potential for growth.
   - 这个新市场有很大的增长潜力。

3. **场景三：科学研究**
   - This discovery could unlock vast potential in renewable energy.
   - 这一发现可能会在可再生能源领域释放巨大的潜力。
...
1. The government is trying to reduce poverty in rural areas.  
   **翻译**: 政府正在努力减少农村地区的贫困。

2. Many people in the city live below the poverty line.  
   **翻译**: 城市里很多人生活在贫困线以下。

3. Poverty can lead to a lack of education and opportunities.  
   **翻译**: 贫困可能导致缺乏教育和机会。
...
### 列举例句
1. **场景一：描述人**
   - She is a powerful speaker who can inspire thousands of people.
   - 她是一位能激励成千上万人的强大演讲者。

2. **场景二：描述机器**
   - This new computer is incredibly powerful and can handle complex tasks with ease.
   - 这台新电脑非常强大，可以轻松处理复杂的任务。

3. **场景三：描述自然力量**
   - The storm was so powerful that it knocked down several trees in the neighborhood.
   - 这场风暴非常强大，把附近的几棵树都吹倒了。
...
2. **场景二：体育训练**
   - The team practises every evening after school.
   - 球队每天放学后练习。

3. **场景三：语言学习**
   - He practises speaking English with his friends.
   - 他和朋友们一起练习说英语。
...
1. She prayed for her family's safety.  
   **翻译**: 她为家人的安全祈祷。

2. They pray every morning before breakfast.  
   **翻译**: 他们每天早餐前祈祷。

3. He prayed to God for forgiveness.  
   **翻译**: 他祈求上帝的宽恕。
...
1. "He took every precaution to ensure the safety of the children."  
   **翻译**: 他采取了每一种预防措施来确保孩子们的安全。

2. "Wearing a helmet is an important precaution when riding a bike."  
   **翻译**: 骑自行车时戴头盔是一项重要的预防措施。

3. "The government has implemented several precautions to prevent the spread of the virus."  
...
1. **场景一：购物**
   - I have a preference for organic products.
   - 我更喜欢有机产品。
...
3. **场景三：饮食**
   - She has a preference for Italian cuisine over French cuisine.
   - 比起法国菜，她更喜欢意大利菜。
...
1. "The company aims to eliminate prejudice in the workplace."  
   **翻译**: "该公司旨在消除工作场所的偏见。"

2. "Her prejudice against foreigners made it difficult for her to make friends."  
   **翻译**: "她对外国人的偏见使她难以交到朋友。"

3. "Prejudice can lead to discrimination and social injustice."  
   **翻译**: "偏见可能导致歧视和社会不公。"
...
3. **场景三：旅行**
   - They are preparing their luggage for the trip to Paris.
   - 他们正在为去巴黎的旅行收拾行李。
...
2. **场景：心理上的存在感**
   - **** The room felt cold without his presence.
   - **** 没有他在场，房间感觉很冷清。

3. **场景：网络上的存在**
   - **** The company's online presence has significantly increased this year.
   - **** 公司今年的在线存在感显著增强。
...
2. **场景二：新闻报道**
   - The press conference was held to announce the new policy.
   - 新闻发布会是为了宣布新政策而举行的。
   
3. **场景三：压力**
   - The press of the crowd made it difficult to move.
   - 人群的压力使得移动变得困难。
...
3. **场景三：戏剧表演**
   - The actor pretended to cry on stage to make his performance more convincing.
   - 演员在舞台上假装哭泣，以使他的表演更加令人信服。
...
- **固定搭配**: pretend to do something (假装做某事), pretend that (假装……), pretend not to know (假装不知道)
   - He pretended not to know the answer. (他假装不知道答案。)
   - She pretended that she was sick to avoid the meeting. (她假装生病以避免会议。)
...
2. **场景**: 在安全方面
   - Wearing a seatbelt prevents serious injuries in case of an accident.
   - 系安全带可以在发生事故时防止严重受伤。

3. **场景**: 在工作环境中
   - The new safety measures are designed to prevent workplace accidents.
   - 新的安全措施旨在防止工作场所事故。
...
### 列举例句
1. **场景一：时间顺序**
   - The previous meeting was held last month.
   - 上一次会议是在上个月举行的。

2. **场景二：顺序**
   - Please review the previous chapter before moving on to this one.
   - 请在继续阅读本章之前回顾上一章。
...
1. **场景一：个人成就**
   - She took great pride in her academic achievements.
   - 她对自己的学术成就感到非常自豪。

2. **场景二：团队合作**
   - The team's pride in their victory was evident.
   - 团队对他们的胜利感到明显的自豪。
...
1. The event was primarily focused on raising awareness about environmental issues.  
   **翻译**: 这次活动主要目的是提高人们对环境问题的认识。

2. She is primarily a teacher, but she also writes books.  
   **翻译**: 她主要是一名教师，但她也写书。

3. The funding for the project will primarily come from private donations.  
   **翻译**: 该项目的资金主要来自私人捐款。
...
2. **场景二：童话故事**  
   - The princess fell in love with the charming prince.  
   - 公主爱上了那位迷人的王子。

3. **场景三：现代社会**  
   - He was considered a prince in the world of finance.  
   - 他被认为是金融界的王子。
...
2. **场景**: 在现代皇室中
   - Princess Diana was beloved by many people.
   - 戴安娜王妃深受许多人喜爱。

3. **场景**: 形容某人优雅
   - She looked like a princess in her beautiful gown.
   - 她穿着美丽的礼服，看起来像一位公主。
...
1. **场景一：商业**  
   - "The company operates based on the principle of honesty and transparency."  
   - "公司基于诚实和透明的原则运营。"

2. **场景二：教育**  
   - "The principle of fairness should be applied in all educational decisions."  
   - "公平的原则应适用于所有教育决策中。"

3. **场景三：科学**  
   - "The principle of conservation of energy is a fundamental concept in physics."  
   - "能量守恒原理是物理学中的一个基本概念。"
...
1. **场景一：印刷书籍**  
   - The publishing house prints thousands of books every year.  
   - 这家出版社每年印刷数千本书籍。  

2. **场景二：打印文档**  
   - Please print the document before the meeting starts.  
   - 请在会议开始前打印好这份文件。  

3. **场景三：版画艺术**  
   - She specializes in woodcut prints, which are a traditional form of art.  
   - 她专门从事木刻版画，这是一种传统的艺术形式。  
...
### 列举例句
1. **场景一：时间顺序**
   - "I had a prior engagement, so I couldn't attend the meeting."
   - “我之前有个约会，所以没能参加会议。”

2. **场景二：优先级**
   - "Safety should always be given prior consideration."
   - “安全应始终被优先考虑。”

3. **场景三：宗教背景**
   - "The prior of the monastery welcomed us warmly."
   - “修道院的院长热情地欢迎了我们。”
...
- **固定搭配**: 
  - "prior to" (在…之前)
    - "Prior to the meeting, we reviewed the agenda." (在会议之前，我们审查了议程。)
...
2. **场景二：社会观察**
   - Many people believe that prison should be used as a place for rehabilitation, not just punishment.
   - 许多人认为监狱应该是一个改造的地方，而不仅仅是惩罚。

3. **场景三：历史背景**
   - In ancient times, prisons were often used to hold political dissidents.
   - 在古代，监狱常被用来关押政治异见者。
...
### 列举例句
1. **场景一：法律背景**  
   - The prisoner was sentenced to 20 years in prison for his crime.  
   - 这名囚犯因犯罪被判处20年监禁。

2. **场景二：情感表达**  
   - She felt like a prisoner in her own home, unable to leave due to fear.  
   - 她感觉自己像家里的囚犯，因为恐惧而无法离开。

3. **场景三：比喻用法**  
   - The trapped bird flapped its wings, longing to be free from its cage, like a prisoner yearning for escape.  
   - 被困的小鸟拍打着翅膀，渴望从笼子里逃脱，就像一个渴望自由的囚犯。
...
2. **场景二：军事等级**
   - "He was promoted to the rank of private."
   - "他被提升为列兵。"
   
3. **场景三：隐私保护**
   - "This is a private conversation; no one else should listen in."
   - "这是私人谈话，其他人不应偷听。"
...
1. **场景一：社会地位**
   - "Being born into a wealthy family is a privilege that not everyone has."
   - "出生在富裕家庭是一种并非人人都能拥有的特权。"

2. **场景二：工作环境**
   - "Employees are given the privilege of working from home during the pandemic."
   - "在疫情期间，员工享有在家工作的特权。"

3. **场景三：教育机会**
   - "Access to top universities is often seen as a privilege of the elite."
   - "进入顶尖大学通常被视为精英的特权。"
...
- **固定搭配**：no problem（没问题）, have a problem with（对……有问题）, solve the problem（解决问题）。  
  例如：No problem, I can help you with that.  没问题，我可以帮你解决那个问题。  或者 Have a problem with the new policy?  对新政策有问题吗？  或者 We need to solve the problem quickly.  我们需要快速解决问题。
...
1. **场景一：工业生产**
   - The factory produces cars efficiently.
   - 这家工厂高效地生产汽车。

2. **场景二：科学研究**
   - The scientist produced a groundbreaking theory.
   - 这位科学家提出了一项突破性的理论。

3. **场景三：农贸市场**
   - We bought fresh produce at the farmers' market.
   - 我们在农贸市场买了新鲜的农产品。
...
1. **场景一：职场描述**
   - She is a professional in the field of architecture.
   - 她是建筑领域的专业人士。

2. **场景二：服务态度**
   - The waiter provided a very professional service.
   - 服务员提供了非常专业的服务。

3. **场景三：比赛表现**
   - The tennis player showed a professional attitude during the match.
   - 网球运动员在比赛中展现了专业的态度。
...
1. **教育场景**：  
   - The school has adopted a progressive teaching method that emphasizes student-centered learning.  
   - 学校采用了强调学生为中心学习的进步教学方法。

2. **政治场景**：  
   - The new government is known for its progressive policies on environmental protection.  
   - 新政府以其环境保护方面的进步政策而闻名。

3. **科技场景**：  
   - This company is at the forefront of progressive technology in the field of artificial intelligence.  
   - 这家公司在人工智能领域的先进技术方面处于领先地位。
...
3. **场景三：工作场所**
   - The company prohibits employees from sharing confidential information with outsiders.
   - 公司禁止员工与外界分享机密信息。
...
### 列举例句
1. **场景一：职场晋升**
   - The manager decided to promote John to the position of assistant director.
   - 经理决定将约翰提升为助理总监。

2. **场景二：产品推广**
   - The company launched a new campaign to promote their latest smartphone.
   - 公司启动了一项新活动来推广他们最新的智能手机。

3. **场景三：健康促进**
   - The government is promoting a healthy lifestyle through various public programs.
   - 政府通过各种公共项目来促进健康的生活方式。
...
1. **人称代词**：
   - She is my friend. **She** often helps me with my homework.
   - 她是我的朋友。她经常帮我做作业。
   
2. **物主代词**：
   - This is **my** book. **Your** book is on the table.
   - 这是我的书。你的书在桌子上。
...
4. **指示代词**：
   - **This** is the car I bought last week. **That** one is too expensive.
   - 这是我上周买的车。那辆太贵了。
...
1. **场景一：语言学习**
   - "She carefully pronounced each word to ensure her accent was correct."
   - 她仔细地发每一个单词的音，以确保她的口音是正确的。

2. **场景二：正式声明**
   - "The judge pronounced the sentence after listening to all the evidence."
   - 法官在听取了所有证据后宣布了判决。
...
1. **场景**: 在语言课堂上
   ...
   - 老师纠正了我“schedule”这个词的发音。

2. **场景**: 在日常对话中
   - Her pronunciation of English is very clear and easy to understand.
   - 她的英语发音非常清晰，容易理解。

3. **场景**: 在广播节目中
   - The announcer's pronunciation is always perfect, which makes the news sound professional.
   - 播音员的发音总是很完美，这让新闻听起来很专业。
...
### 列举例句
1. **场景：礼仪**  
   - It is not proper to interrupt someone when they are speaking.  
   - 打断别人说话是不礼貌的。

2. **场景：正式场合**  
   - Please wear proper attire for the formal dinner.  
   - 请穿正式服装参加晚宴。

3. **场景：正确性**  
   - Make sure you use the proper spelling of the word.  
   - 确保你使用了该单词的正确拼写。
...
2. **场景二：物理特性**
   - "The property of water is to take the shape of its container."
   - “水的特性是能取容器的形状。”

3. **场景三：知识产权**
   - "The company owns the intellectual property rights for this software."
   - “公司拥有这款软件的知识产权。”
...
2. A large proportion of the population lives below the poverty line.  
   **翻译**: 很大一部分人口生活在贫困线以下。
   
3. The cake was divided into equal proportions for everyone.  
   **翻译**: 蛋糕被均匀地分成几份，每人一份。
...
1. The increase in salary is proportional to the amount of work done.  
   **翻译**: 工资的增加与完成的工作量成正比。

2. The size of the painting should be proportional to the wall space available.  
   **翻译**: 画的大小应与可用的墙空间相称。

3. Her contribution to the project was proportional to her experience.  
   **翻译**: 她对项目的贡献与她的经验相称。
...
1. "She presented a proposal for the new project."  
   **翻译**: 她为新项目提出了一个建议。
   
2. "The committee will review the proposal next week."  
   **翻译**: 委员会将在下周审查这个提案。
   
3. "He made a proposal to his girlfriend during the dinner."  
   **翻译**: 他在晚餐时向女朋友求婚。
...
1. **场景一：个人安全**
   - "Wearing a helmet provides protection for cyclists."
   - "戴头盔为骑自行车的人提供了保护。"

2. **场景二：环境保护**
   - "The government implemented new laws to ensure the protection of endangered species."
   - "政府实施了新法律，以确保对濒危物种的保护。"

3. **场景三：金融保护**
   - "Insurance is a form of financial protection against unexpected events."
   - "保险是一种针对意外事件的金融保护形式。"
...
1. "Eating enough protein is essential for muscle growth."  
   **翻译**: "摄入足够的蛋白质对肌肉生长至关重要。"
   
2. "This smoothie is packed with protein to keep you energized throughout the day."  
   **翻译**: "这种奶昔富含蛋白质，可以让你一整天都精力充沛。"
   
3. "The doctor recommended a high-protein diet to help with recovery."  
   **翻译**: "医生建议采用高蛋白饮食来帮助恢复。"
...
2. **场景二：家庭关系**
   - The father was proud of his son's success.
   - 父亲为儿子的成功感到骄傲。
   
3. **场景三：国家荣誉**
   - The nation was proud of its athletes winning gold medals.
   - 全国人民为运动员赢得金牌感到骄傲。
...
### 列举例句
1. **场景一：日常生活**
   - She provides food for her family every day.
   - 她每天为家人提供食物。
...
3. **场景三：教育**
   - The teacher provides additional resources for students who need extra help.
   - 老师为需要额外帮助的学生提供额外的资源。
...
1. **场景一：学术讨论**  
   - The professor conducted a psychological study on stress management.  
   - 教授进行了一项关于压力管理的心理学研究。

2. **场景二：日常对话**  
   - She experienced some psychological effects after the accident.  
   - 事故后，她经历了一些心理影响。

3. **场景三：健康咨询**  
   - It's important to address both physical and psychological well-being.  
   - 关注身体和心理健康都很重要。
...
### 列举例句
1. **场景一：书籍出版**  
   - The author decided to publish his first novel next month.  
   - 这位作家决定下个月出版他的第一本小说。

2. **场景二：新闻发布**  
   - The company will publish its financial report tomorrow.  
   - 公司将在明天发布财务报告。

3. **场景三：学术论文发表**  
   - She worked hard to get her research published in a prestigious journal.  
   - 她努力工作，以使她的研究发表在一本享有盛誉的期刊上。
...
2. **场景二：体育运动**
   - He pulled his muscle during the race.
   - 他在比赛中拉伤了肌肉。
...
### 列举例句
1. **场景一：机械设备**
   - The farmer used a pump to irrigate his fields.
   - 农夫用水泵灌溉他的田地。
   
2. **场景二：比喻用法**
   - The coach tried to pump up the team's morale before the big game.
   - 教练在大赛前试图提升队员的士气。
   
3. **场景三：信息传递**
   - The journalist was accused of pumping false information into the media.
   - 记者被指控向媒体散布虚假信息。
...
2. **场景二：学校**
   - The teacher appreciates students who are punctual.
   - 老师欣赏那些守时的学生。

3. **场景三：日常生活**
   - He was punctual to the minute when he arrived at the restaurant.
   - 他到达餐厅时一分不差，非常准时。
...
### 列举例句
1. **场景一：购物**
   - She made a purchase at the local supermarket.
   - 她在当地超市买了一件商品。

2. **场景二：商业交易**
   - The company secured the purchase of a new office building.
   - 公司确保了新办公楼的购买。

3. **场景三：机械操作**
   - The worker used leverage to make the purchase of the heavy machinery easier.
   - 工人使用杠杆来更容易地操作重型机械。
...
3. **场景三：描述物品**  
   - He bought a purple pen for his sister.  
   - 他给妹妹买了一支紫色的笔。
...
1. **场景一：日常生活中的钱包**
   - She always keeps her credit cards in her purse.
   - 她总是把信用卡放在她的钱包里。
   
2. **场景二：购物时的钱包**
   - He reached into his purse to pay for the groceries.
   - 他伸手到钱包里付买杂货的钱。
   
3. **场景三：体育比赛中的奖金**
   - The purse for the golf tournament was $1 million.
   - 高尔夫锦标赛的奖金总额是100万美元。
...
- **固定搭配**: "put on"（穿上），"put off"（推迟），"put up with"（忍受）等。
   - "穿上", "推迟", "忍受".  例如: He put on his coat. (他穿上外套) / We had to put off the meeting. (我们不得不推迟会议) / I can't put up with his behavior any longer. (我再也无法忍受他的行为了) . . . . . . . . . . . . . . . . . . .
...
1. The crossword puzzle in the newspaper keeps my mind sharp.  
   **翻译**: 报纸上的填字游戏让我的头脑保持敏锐。  
2. She was puzzled by his sudden change of attitude.  
   **翻译**: 她对他的态度突然改变感到困惑。  
3. Solving this math puzzle requires a lot of patience.  
   **翻译**: 解决这个数学谜题需要很多耐心。
