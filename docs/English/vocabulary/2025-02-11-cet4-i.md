...
1. **场景一：工作场合**
   - Her presentation impressed the entire board.
   - 她的演讲给整个董事会留下了深刻印象。
   
2. **场景二：社交场合**
   - He impressed everyone with his knowledge of history.
   - 他对历史的了解让每个人都印象深刻。
   
3. **场景三：个人经历**
   - The beauty of the mountains impressed me deeply.
   - 山脉的美丽深深打动了我。
...
2. **印记**  
   - "The impression of his handprint was still visible on the wall."  
   - **翻译**: "他手印的痕迹仍然清晰可见于墙上。"  
   
3. **艺术作品**  
   - "This sculpture is just an impression of what the final piece will look like."  
...
3. **场景三：体育表现**
   - His performance in the race was truly **impressive**.
   - 他在比赛中的表现确实令人印象深刻。
...
### 单词变形和固定搭配组词对应的无明显变形和固定搭配组词对应的中文翻译；因为 "in" 本身是一个基础词汇，没有复杂的变形或固定搭配组词对应的中文翻译；但可以列举一些常见的包含 "in" 的短语：如 "in time"(及时)、 "in trouble"(陷入麻烦)、 "in love"(恋爱中)等；这些短语中的 "in" 都有特定的含义和用法；需要根据具体语境来理解其意义；例如：She is in love with him.(她爱上了他) The project was completed in time.(项目及时完成了) He got in trouble for cheating.(他因作弊而陷入麻烦)等等；这些短语中的 "in" 都不能简单地理解为 "在……里面"；而是有特定的含义和用法；需要根据具体语境来理解其意义；例如：She is in love with him.(她爱上了他) The project was completed in time.(项目及时完成了) He got in trouble for cheating.(他因作弊而陷入麻烦)等等；这些短语中的 "in" 都不能简单地理解为 "在……里面"；而是有特定的含义和用法；需要根据具体语境来理解其意义；例如：She is in love with him.(她爱上了他) The project was completed in time.(项目及时完成了) He got in trouble for cheating.(他因作弊而陷入麻烦)等等；这些短语中的 "in"
...
### 列举例句
1. **场景一：日常生活**
   - "There was a small incident at the park when two children started fighting."
   - "公园里发生了两个孩子打架的小事件。"

2. **场景二：工作场所**
   - "The manager reported the incident to HR immediately after it happened."
   - "经理在事件发生后立即向人力资源部报告了此事。"

3. **场景三：国际关系**
   - "The border incident led to a diplomatic crisis between the two countries."
   - "边境事件导致了两国之间的外交危机。"
...
1. My monthly income is enough to cover my basic expenses.  
   **翻译**: 我的月收入足以支付我的基本开销。
   
2. The company reported a significant increase in income last quarter.  
   **翻译**: 公司上个季度的收入显著增加。
   
3. She relies on rental income to supplement her pension.  
   **翻译**: 她依靠租金收入来补充她的养老金。
...
1. **场景一：工作中的增长**
   - The company has seen a significant increase in sales this quarter.
   - 公司本季度的销售额有了显著增长。

2. **场景二：人口增长**
   - The population of this city has increased by 10% over the past decade.
   - 过去十年，这个城市的人口增长了10%。

3. **场景三：个人技能提升**
   - She has made great efforts to increase her knowledge of computer programming.
   - 她付出了很大努力来提高自己的计算机编程知识。
...
1. **场景：确认信息**
   ...
   - A: "你在项目上做得很好。" B: "确实，我在这个项目上下了很大功夫。"
...
1. **场景一：个人生活**
   - She values her independence and prefers to make her own decisions.
   - 她重视自己的独立性，喜欢自己做决定。

2. **场景二：国家历史**
   - The country celebrated its 50th anniversary of independence this year.
   - 这个国家今年庆祝了其独立50周年。

3. **场景三：经济独立**
   - Achieving financial independence is one of her long-term goals.
   - 实现经济独立是她长期目标之一。
...
### 列举例句
1. **场景：文化**  
   - "The Indian cuisine is known for its rich spices."  
   - "印度菜以其丰富的香料而闻名。"

2. **场景：历史**  
   - "The Indian tribes played a significant role in the history of America."  
   - "印第安部落在美国历史上扮演了重要角色。"

3. **场景：人物**  
   - "She is an Indian who moved to the United States for higher education."  
   - "她是一位为了高等教育而移居美国的印度人。"
...
1. **场景一：个人态度**
   - She was indifferent to the movie's plot.
   - 她对电影的情节漠不关心。

2. **场景二：工作表现**
   - The manager seemed indifferent to the team's concerns.
   - 经理似乎对团队的担忧漠不关心。

3. **场景三：日常生活**
   - He was indifferent about where they ate dinner.
   - 他对他们在哪里吃晚饭无所谓。
...
2. **场景二：路线**
   - The road to the village is quite indirect.
   - 通往村庄的路相当曲折。
   
3. **场景三：影响**
   - His success had an indirect impact on her career.
   - 他的成功对她的职业生涯产生了间接的影响。
...
### 列举例句
1. **场景一：日常生活**
   - "She prefers to stay indoors during the rainy season."
   - "她喜欢在雨季时待在室内。"

2. **场景二：运动**
   - "The basketball game was moved indoors due to the bad weather."
   - "由于天气不好，篮球比赛被移到室内进行。"

3. **场景三：工作环境**
   - "The meeting will be held indoors to avoid the heat."
   - "会议将在室内举行，以避免炎热。"
...
1. The government is planning to industrialize the rural areas to boost the economy.  
   **翻译**: 政府计划将农村地区工业化以促进经济发展。

2. Many countries have industrialized rapidly in the past century.  
   **翻译**: 许多国家在过去的一个世纪里迅速实现了工业化。

3. The industrialization of this region has led to significant environmental changes.  
...
1. **场景一：学术讨论**
   - "From the data presented, we can infer that the new drug is effective."
   - "从所提供的数据中，我们可以推断出新药是有效的。"

2. **场景二：日常对话**
   - "She didn't say she was angry, but her tone of voice allowed us to infer it."
   - "她没有说她生气了，但她的语气让我们推断出她生气了。"

3. **场景三：法律分析**
   - "The judge inferred guilt from the lack of an alibi."
   - "法官从缺乏不在场证明中推断出有罪。"
...
2. **场景二：地位比较**
   - As a new employee, she felt inferior to her colleagues.
   - 作为新员工，她觉得自己不如同事们。

3. **场景三：能力比较**
   - His performance was inferior compared to the previous season.
   - 与上个赛季相比，他的表现较差。
...
3. **场景三：日常生活**
   - "Can you inform me when the bus arrives?"
   - "你能告诉我公交车什么时候到吗？"
...
2. The city has a diverse population, with inhabitants from all over the world.  
   **翻译**: 这座城市有来自世界各地的多样化人口。

3. The inhabitants of the forest are facing threats from deforestation.  
...
1. **场景一：描述过程的开始**
   - The initial step in any project is planning.
   - 任何项目的最初步骤都是计划。

2. **场景二：描述名字的首字母**
   - Her initials are J.K., standing for Jane Kelly.
   - 她的首字母是 J.K.，代表 Jane Kelly。

3. **场景三：描述产品的初次发布**
   - The company released the initial version of the software last month.
   - 公司上个月发布了软件的初始版本。
...
### 列举例句
1. **场景一：旅行住宿**
   - "We stayed at a charming inn during our trip to the countryside."
   - "我们在乡村旅行时住进了一家迷人的旅馆。"

2. **场景二：历史背景**
   - "In medieval times, inns were popular places for travelers to rest and socialize."
   - "在中世纪，旅馆是旅行者休息和社交的热门场所。"

3. **场景三：文学引用**
   - "The novel describes an old inn where the protagonist finds refuge."
   - "小说描述了一家古老的旅馆，主角在那里找到了庇护。"
...
1. **场景一：描述物理空间**
   - The inner room was much warmer than the outer one.
   - 内室比外室暖和得多。
...
3. **场景三：描述精神层面**
   - He has a strong inner strength that helps him overcome difficulties.
   - 他有着强大的内在力量，帮助他克服困难。
...
2. **场景二：儿童**
   - The little girl had an innocent smile on her face.
   - 小女孩脸上带着天真的微笑。

3. **场景三：食品**
   - This milk is made from all-natural, innocent ingredients.
   - 这种牛奶是由纯天然、无添加的成分制成的。
...
### 列举例句
1. **场景一：计算机操作**
   - Please provide your input before we finalize the project plan.
   - 在我们最终确定项目计划之前，请提供您的输入。
   
2. **场景二：数学计算**
   - The function requires two inputs: x and y.
   - 这个函数需要两个输入：x 和 y。
...
### 列举例句
1. **场景一：学术环境**
   - She decided to inquire about the scholarship opportunities at the university.
   - 她决定询问大学里的奖学金机会。

2. **场景二：商业会议**
   - During the meeting, the manager inquired about the progress of the new project.
   - 在会议上，经理询问了新项目的进展情况。

3. **场景三：日常对话**
   - I will inquire at the reception desk if there are any available rooms.
   - 我会在前台询问是否有空房间。
...
1. **场景一：工作中的激励**
   ...
   - 她的成功故事激励了许多年轻企业家去追求他们的梦想。

2. **场景二：艺术创作中的灵感**
   - "The beautiful sunset inspired the artist to create a masterpiece."
   - 美丽的日落激发了艺术家创作出一幅杰作。

3. **场景三：教育中的启发**
   - "The teacher's passion for science inspired the students to explore the subject further."
   - 老师对科学的热情激发了学生们进一步探索这个学科。
...
- **固定搭配**：instead of（代替……；而不是……）  
  Instead of going to the gym, I decided to take a walk in the park.（我没有去健身房，而是决定去公园散步。）  
  我没有去健身房，而是决定去公园散步。  
  其他固定搭配较少见。  
  组词方面也没有太多常见的组合形式。  
...
1. **场景一：日常对话**
   - "His rude comment was an insult to her intelligence."
   - "他粗鲁的评论是对她智力的侮辱。"

2. **场景二：工作环境**
   - "She felt insulted when her boss publicly criticized her work."
   - "当她的老板公开批评她的工作时，她感到受到了侮辱。"

3. **场景三：社交场合**
   - "Insulting someone in public can lead to serious consequences."
   - "在公共场合侮辱他人可能会导致严重的后果。"
...
1. **场景一：健康保险**
   - "She pays for health insurance to cover any medical expenses."
   - "她购买了健康保险，以支付任何医疗费用。"

2. **场景二：汽车保险**
   - "He got into a car accident, but his insurance covered the damage."
   - "他发生了车祸，但他的保险覆盖了损失。"

3. **场景三：房屋保险**
   - "They took out home insurance to protect their property from natural disasters."
   - "他们购买了房屋保险，以保护他们的财产免受自然灾害的影响。"
...
3. **场景三：保障**
   - The company wants to insure its employees' future by offering retirement plans.
   - 公司希望通过提供退休计划来保障员工的未来。
...
1. **场景一：学术讨论**
   - "The professor's lecture was highly intellectual, focusing on complex theories."
   - 教授的讲座非常学术化，专注于复杂的理论。
...
3. **场景三：社会角色**
   - "Many intellectuals in the community are advocating for educational reforms."
   - 社区中的许多知识分子正在倡导教育改革。
...
1. **场景一：日常对话**
   - "I didn't mean to hurt your feelings; it was not my intention."
   - "我不是有意伤害你的感情；这不是我的本意。"

2. **场景二：工作场合**
   - "The company's intention is to expand into new markets next year."
   - "公司的意图是明年扩展到新市场。"

3. **场景三：学术写作**
   - "The study's primary intention was to explore the effects of climate change on local wildlife."
   - "这项研究的主要意图是探讨气候变化对当地野生动物的影响。"
...
### 列举例句
1. **场景一：个人生活**
   - She decided not to interfere in her friend's personal life.
   - 她决定不干涉朋友的私生活。

2. **场景二：技术问题**
   - The noise from the construction site is interfering with our internet connection.
   - 建筑工地的噪音干扰了我们的网络连接。

3. **场景三：国际关系**
   - The country has warned against any foreign powers interfering in its internal affairs.
   - 该国警告任何外国势力不要干涉其内政。
...
3. **场景三：技术领域**
   - "The software can interrupt the process if an error is detected."
   - “如果检测到错误，软件可以中断进程。”
...
1. **场景一：求职面试**
   - I have an interview for a job at a tech company tomorrow.
   - 我明天有一个科技公司的求职面试。

2. **场景二：新闻采访**
   - The journalist will interview the president about the new policy.
   - 记者将就新政策采访总统。

3. **场景三：学术访谈**
   - The professor will interview several candidates for the research assistant position.
   - 教授将为研究助理职位面试几位候选人。
...
- **固定搭配**: get into (进入), look into (调查), run into (偶然遇到)。
   - get into (进入), look into (调查), run into (偶然遇到)。
...
2. **场景二：商业会议**
   - "The CEO introduced the new strategy during the meeting."
   - “CEO在会议上介绍了新的战略。”

3. **场景三：教育环境**
   - "The teacher introduced a new topic in the class."
   - “老师在课堂上引入了一个新话题。”
...
1. **场景一：社交场合**
   - "During the meeting, the manager gave an introduction of the new team member."
   - “在会议上，经理介绍了新团队成员。”

2. **场景二：学术环境**
   - "The professor's introduction to the course provided a clear overview of what to expect."
   - “教授的课程介绍清楚地概述了我们将要学习的内容。”

3. **场景三：书籍或文章**
   - "The introduction of the book discusses the author's motivation for writing it."
   - “这本书的引言部分讨论了作者写作的动机。”
...
1. Thomas Edison was a famous inventor who created the light bulb.  
   托马斯·爱迪生是一位著名的发明家，他发明了电灯泡。
   
2. The inventor of the smartphone revolutionized the way we communicate.  
   智能手机的发明者彻底改变了我们的沟通方式。
   
3. She dreams of becoming an inventor like her hero, Nikola Tesla.  
   她梦想成为像她的偶像尼古拉·特斯拉那样的发明家。
...
3. **场景三：情感投入**
   - They invested their hearts into the relationship.
   - 他们在这段关系中倾注了全部感情。
...
1. **场景一：犯罪调查**
   - The police will investigate the robbery that occurred last night.
   - 警方将调查昨晚发生的抢劫案。

2. **场景二：科学研究**
   - Scientists are investigating the effects of climate change on marine life.
   - 科学家们正在研究气候变化对海洋生物的影响。

3. **场景三：学术研究**
   - She decided to investigate the history of ancient Rome for her dissertation.
   - 她决定为她的论文研究古罗马的历史。
...
1. The air we breathe is invisible.  
   **翻译**: 我们呼吸的空气是看不见的。
   
2. She wore an invisible cloak that made her disappear from sight.  
   **翻译**: 她穿了一件隐形斗篷，使她从视线中消失。
   
3. Many stars in the night sky are invisible to the naked eye.  
   **翻译**: 夜空中许多星星是肉眼看不见的。
