...
### 列举例句
1. **场景一：家庭使用**
   - "Please check the temperature on the thermometer before giving the medicine to the child."
   - "请在使用药物前用温度计检查孩子的体温。"

2. **场景二：科学实验**
   - "The scientist carefully read the temperature from the thermometer placed in the liquid."
   - "科学家仔细地从放在液体中的温度计上读取温度。"

3. **场景三：气象观测**
   - "The meteorologist noted the outdoor temperature using a digital thermometer."
   - "气象学家使用数字温度计记录了室外的温度。"
...
1. **场景一：个人威胁**
   - He threatened to leave the company if they didn't give him a raise.
   - 他威胁说，如果公司不给他加薪，他就辞职。

2. **场景二：自然灾害**
   - The storm is threatening to flood the entire town.
   - 暴风雨有可能淹没整个城镇。

3. **场景三：法律威胁**
   - The government threatened to impose sanctions on the country if they didn't comply with international laws.
   - 政府威胁说，如果该国不遵守国际法，将对其实施制裁。
...
### 列举例句
1. **场景：医学检查**  
   - The doctor asked the patient to open his mouth and say "Ah" to examine his throat.  
   - 医生让病人张开嘴说“啊”，以检查他的喉咙。

2. **场景：日常对话**  
   - She cleared her throat before speaking to make sure her voice was clear.  
   - 她在说话前清了清嗓子，以确保声音清晰。

3. **场景：描述不适**  
   - He had a sore throat and couldn't eat anything spicy.  
   - 他喉咙痛，不能吃任何辛辣的食物。
...
- **名词形式**：throat (单数) / throats (复数)  
  She has a sore throat. / They all complained of sore throats.  
  她喉咙痛。/他们都抱怨喉咙痛。
...
### 列举例句
1. **场景1：时间**
   - "She read the book throughout the week."
   - 她整个星期都在读这本书。

2. **场景2：空间**
   - "The house was painted blue throughout."
   - 整个房子都被漆成了蓝色。
...
1. He studied hard; thus, he passed the exam.  
   **翻译**: 他努力学习；因此，他通过了考试。

2. The weather was bad, thus the game was canceled.  
   **翻译**: 天气不好，所以比赛被取消了。

3. She followed the instructions carefully; thus, she completed the task successfully.  
...
### 列举例句
1. **场景一：化学元素**
   - Tin is a soft, silvery metal used in making cans and alloys.
   - 锡是一种柔软的银白色金属，用于制造罐头和合金。
   
2. **场景二：容器**
   - She packed her cookies in a tin to keep them fresh.
   - 她把饼干装在锡罐里以保持新鲜。
   
3. **场景三：形容词用法**
   - The old man played a tin whistle during the festival.
   - 老人在节日期间吹奏了一支锡制的哨子。
...
- "Tin" 是一个基本词汇，没有常见的词缀变化。然而，它可以与其他词缀结合形成新词，例如：
  - **tinned** (形容词): 表示“镀锡的”或“罐装的”。
    - The tinned vegetables are easy to store.
    - 罐装蔬菜易于储存。
...
2. **场景二：运动**
   - "He kicked the ball with his big toe."
   - “他用大脚趾踢了球。”

3. **场景三：医学**
   - "The doctor examined the patient's toes for any signs of injury."
   - “医生检查了患者的脚趾，看是否有受伤的迹象。”
...
### 列举例句
1. **场景一：家庭环境**
   - "Please go to the toilet before we leave."
   - "在我们离开之前，请先去一下厕所。"
...
3. **场景三：个人护理**
   - "She spends a lot of time in the toilet doing her makeup."
   - "她在厕所里花了很多时间化妆。"
...
### 列举例句
1. **场景一：日常生活**
   - "I can't tolerate the smell of cigarettes."
   - "我无法忍受香烟的味道。"

2. **场景二：工作环境**
   - "The manager has to tolerate some mistakes from new employees."
   - "经理必须容忍新员工的某些错误。"

3. **场景三：社会问题**
   - "Society should not tolerate any form of discrimination."
   - "社会不应容忍任何形式的歧视。"
...
- **固定搭配**：set the tone（定下基调）, tone down（缓和；降低强度）, tone up（提高强度；增强体质）等。  
  The speaker set a serious tone for the meeting.  演讲者为会议定下了严肃的基调。  
  She toned down her criticism after realizing it was too harsh.  意识到批评过于严厉后，她缓和了语气。  
  Regular exercise can help tone up your muscles.  定期锻炼有助于增强肌肉力量。  
...
### 列举例句
1. **场景一：旅游**
   - "We are planning a tour of Europe this summer."
   - "我们计划今年夏天去欧洲旅行。"
...
1. **场景一：犯罪调查**
   - The detective managed to trace the suspect's movements using CCTV footage.
   - 侦探通过监控录像成功追踪了嫌疑人的行踪。
   
2. **场景二：科学研究**
   - Scientists found traces of ancient DNA in the fossil.
   - 科学家在化石中发现了古代DNA的痕迹。
   
3. **场景三：艺术创作**
   - She traced the outline of the tree before painting it.
   - 她在画画前先描绘了树的轮廓。
...
1. **** The farmer used a tractor to plow the field.  
   **翻译：** 农民用拖拉机犁地。  
2. **** The tractor pulled the trailer full of hay.  
   **翻译：** 拖拉机拉着装满干草的拖车。  
3. **** He drove the tractor carefully across the muddy field.  
   **翻译：** 他小心地开着拖拉机穿过泥泞的田地。
...
-  经历转变, 带来变革, 转型过程, 文化转型, 数字化转型, 个人转变.
...
1. The transistor is a fundamental component in modern electronics.  
   晶体管是现代电子设备中的基本组件。

2. This radio uses several transistors to amplify the sound.  
   这台收音机使用多个晶体管来放大声音。

3. The invention of the transistor revolutionized the electronics industry.  
   晶体管的发明彻底改变了电子工业。
...
- **复数形式**: trays（多个托盘）  
- **固定搭配**:  
   1. *serving tray*: 服务用托盘；用于端送食物和饮料的专用托盘；The hostess used a serving tray to bring out tea and cookies.（女主人用服务用托盘端出了茶和饼干。）   2. *tea tray*: 茶具托盘；用于摆放茶壶、杯子和点心的专用托盘；She set up a tea tray for her afternoon guests.（她为下午的客人准备了一个茶具托盘。）   3. *cookie tray*: 饼干烤盘；用于烘烤饼干的专用烤盘；The cookies were perfectly baked on the cookie tray.（饼干在烤盘中被完美地烘烤好了。）   4. *tray table*: (床上/沙发上的)小桌板；可折叠的小桌子；He placed his laptop on the tray table while lying on the couch.（他躺在沙发上时把笔记本电脑放在小桌板上。）   5. *on a tray*: (某物)被放在一个托盘中；The waiter brought the drinks on a tray to our table.（服务员把饮料放在一个托盘中端到了我们的桌上。）   6. *empty tray*: (空的)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西的(空)空置的/未使用的/未装满东西
...
2. **场景二：处理**
   - "This machine is used to treat waste water."
   - 这台机器用于处理废水。
...
- **动词形式**：无常见动词形式，但可以理解为 "to trend"（成为热门）。例如："The topic started to trend on Twitter."（这个话题开始在Twitter上成为热门。）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门。”）“这个话题开始在Twitter上成为热门
...
1. **场景一：园艺**
   - She spent the afternoon trimming the hedges.
   - 她花了一个下午修剪树篱。
   
2. **场景二：服装**
   - The dress had a trim of lace around the edges.
   - 这条裙子在边缘处有蕾丝装饰。
   
3. **场景三：船只**
   - The sailors trimmed the sails to catch the wind better.
   - 水手们调整了帆以更好地利用风力。
...
### 列举例句
1. **场景一：体育比赛**  
   - Our team achieved a great triumph in the final match.  
   - 我们的队伍在决赛中取得了巨大的胜利。

2. **场景二：个人成就**  
   - She felt a sense of triumph after completing her first marathon.  
   - 完成她的第一次马拉松后，她感到一种胜利的喜悦。

3. **场景三：历史事件**  
   - The Allied forces celebrated their triumph over the Axis powers in World War II.  
   - 二战期间，盟军庆祝他们对轴心国的胜利。
...
2. **场景二：商业合作**
   - "The company has built a reputation based on trust."
   - "这家公司以信任为基础建立了声誉。"
   
3. **场景三：技术可靠性**
   - "You can trust this software to protect your data."
   - "你可以信赖这款软件来保护你的数据。"
...
### 列举例句
1. **场景一：科学实验室**
   - "The scientist poured the liquid into the test tube."
   - "科学家将液体倒入试管中。"

2. **场景二：日常生活**
   - "Please pass me the tube of toothpaste."
   - "请把那支牙膏递给我。"
...
2. **场景二：自然**
   - "The twin peaks of the mountain are very famous."
   - "这座山的双峰非常有名。"
   
3. **场景三：产品**
   - "This company produces twin-engine airplanes."
   - "这家公司生产双引擎飞机。"
...
1. **场景一：描述天气**
   - "It's typical of British weather to change so quickly."
   - “英国的天气变化无常是很典型的。”
...
3. **场景三：描述产品**
   - "This model is a typical example of the brand's design philosophy."
   - “这款型号是该品牌设计理念的典型代表。”
