...
1. She accomplished her goal of running a marathon in under four hours.  
...
2. "She is just an acquaintance, not someone I would confide in."  
...
3. They planted wheat on the 10-acre field.  
   **翻译**: 他们在10英亩的土地上种植了小麦。
...
3. She received an additional bonus for her outstanding performance.  
   **翻译**: 她因表现出色而获得了额外的奖金。
...
### 列举例句
1. **场景一：旅行**
   - "She decided to go on an adventure to explore the Amazon rainforest."
   - "她决定去亚马逊雨林探险。"
   
2. **场景二：生活经历**
   - "Starting a new business was an adventure that taught him a lot about risk and reward."
   - "创业是一次让他学到很多关于风险与回报的冒险。"
   
3. **场景三：文学作品**
   - "The novel is full of adventures, from pirate ships to hidden treasures."
   - "这本小说充满了冒险，从海盗船到隐藏的宝藏。"
...
### 列举例句
1. **场景一：家庭关系**  
   - She has a deep affection for her younger brother.  
   - 她对她的弟弟有着深厚的感情。

2. **场景二：爱情**  
   - Their affection for each other grew stronger over time.  
   - 随着时间的推移，他们对彼此的感情越来越深。

3. **场景三：宠物**  
   - The old couple showered their dog with affection.  
   - 这对老夫妇对他们的狗充满了爱意。
...
2. **场景二：故事叙述**
   - The movie ended at 10 PM, and afterward, everyone went home.
   - 电影在晚上10点结束，之后大家都回家了。

3. **场景三：学术写作**
   - Afterward, the researcher analyzed the data collected from the experiment.
   - 随后，研究人员分析了从实验中收集的数据。
...
2. **场景二：商业环境中的进取心**
   - She is known for her aggressive marketing strategies.
   - 她以积极的营销策略而闻名。
   
3. **场景三：医疗中的激进治疗**
   - The doctor suggested an aggressive treatment plan for the patient's cancer.
   - 医生为患者的癌症提出了一个激进的治疗计划。
...
1. The airport was filled with various types of aircraft, from small private planes to large commercial jets.  
   **翻译**: 机场里停满了各种类型的飞行器，从小型私人飞机到大型商用喷气式飞机。

2. The pilot carefully inspected the aircraft before taking off.  
   **翻译**: 飞行员在起飞前仔细检查了飞行器。

3. The military aircraft flew over the city, causing a loud noise.  
   **翻译**: 军用飞机飞过城市，发出巨大的噪音。
...
2. **场景二：描述行为**
   - Both sisters have a similar taste in music; they are alike in that aspect.
   - 两姐妹在音乐品味上很相似；在这方面她们是一样的。

3. **场景三：描述性格**
   - Although they come from different backgrounds, the two friends are quite alike in their personalities.
   - 尽管他们来自不同的背景，这两位朋友在性格上非常相似。
...
### 列举例句
1. **场景一：工业应用**  
   - "The steel used in construction is an alloy of iron and carbon."  
   - "建筑中使用的钢是铁和碳的合金。"

2. **场景二：珠宝制作**  
   - "Gold jewelry is often made from an alloy to increase its durability."  
   - "金饰通常由合金制成，以提高其耐用性。"

3. **场景三：科学实验**  
   - "The scientist mixed copper and zinc to create an alloy with unique properties."  
   - "科学家将铜和锌混合，制成了一种具有独特性能的合金。"
...
2. She taught her child the alphabet before starting to read.  
   **翻译**: 她在孩子开始阅读之前教他字母表。
   
3. The teacher asked the students to recite the alphabet in order.  
   **翻译**: 老师要求学生们按顺序背诵字母表。
...
1. **场景一：日常选择**
   - "I couldn't find my usual brand, so I bought an alternative."
   - “我找不到我常用的品牌，所以我买了一个替代品。”
   
2. **场景二：决策制定**
   - "We need to consider all the alternatives before making a decision."
   - “在做出决定之前，我们需要考虑所有可行的选择。”
...
1. The magician's tricks amazed the audience.  
   **翻译**: 魔术师的把戏让观众感到惊叹。
   
2. She amazed everyone with her incredible performance.  
   **翻译**: 她惊人的表演让每个人都感到惊叹。
   
3. The beauty of the landscape amazed me.  
   **翻译**: 风景的美丽让我感到惊叹。
...
2. **场景二：医院呼叫**
   - The hospital called for an ambulance to transport the patient.
   - 医院呼叫了一辆救护车来运送病人。

3. **场景三：紧急情况**
   - In case of emergency, dial 911 and ask for an ambulance.
   - 在紧急情况下，拨打911并要求救护车。
...
### 单词变形及固定搭配、组词等对应的无变形形式和固定搭配需特别列出。它是一个基础介词，没有复杂的变形形式和固定搭配需要特别列出。它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介词,没有复杂的变形形式和固定搭配需要特别列出.它是一个基础介
...
2. **场景二：文学**  
   - She read an ancient manuscript in the library.  
   - 她在图书馆读了一本古老的文稿。

3. **场景三：建筑**  
   - The ancient temple stood tall amidst the modern buildings.  
   - 这座古老的寺庙在现代建筑中巍然矗立。
...
2. The doctor recommended resting the ankle to avoid further injury.  
   **翻译**: 医生建议休息脚踝以避免进一步受伤。
   
3. He wore a brace on his ankle to support it during recovery.  
...
2. **场景二：工作中的不愉快**
   - His boss's constant criticism really annoyed him.
   - 老板的持续批评真的让他很恼火。

3. **场景三：技术问题**
   - The software's frequent crashes annoyed the users.
   - 软件频繁崩溃让用户感到非常恼怒。
...
1. **场景一：日常生活中的预期**
   - I always anticipate a lot of traffic during rush hour.
   - 我总是预期在高峰时段会有很多交通。

2. **场景二：工作中的预期**
   - The project manager anticipates that the team will complete the task by Friday.
   - 项目经理预期团队将在周五前完成任务。

3. **场景三：情感上的预期**
   - She anticipates meeting her old friends with excitement.
   - 她满怀兴奋地期待与老朋友见面。
...
1. **场景一：日常生活中的焦虑**
   - She felt a wave of anxiety as she approached the interview room.
   - 当她走近面试房间时，她感到一阵焦虑。

2. **场景二：学术环境中的焦虑**
   - The students' anxiety levels increased as the exam date drew near.
   - 随着考试日期的临近，学生们的焦虑水平增加了。

3. **场景三：医疗环境中的焦虑**
   - The doctor prescribed a mild sedative to help reduce his patient's anxiety.
   - 医生开了一种轻度镇静剂来帮助减轻病人的焦虑。
...
1. **场景一：日常生活中的道歉**
   - "I need to apologize to my friend for being late."
   - "我需要为迟到向我的朋友道歉。"

2. **场景二：工作场合中的道歉**
   - "The manager apologized to the team for the miscommunication."
   - "经理为沟通失误向团队道歉。"

3. **场景三：正式场合中的道歉**
   - "The company issued a formal apology for the data breach."
   - "公司因数据泄露发布了正式的道歉。"
...
1. **场景一：饮食**
   - After a long day at work, she had a huge appetite for a big meal.
   - 经过一天的工作后，她非常想吃一顿大餐。

2. **场景二：兴趣**
   - His appetite for learning new languages never seems to diminish.
   - 他对学习新语言的兴趣似乎从未减退。

3. **场景三：欲望**
   - The movie sparked an appetite for adventure in the young boy.
   - 这部电影激发了小男孩对冒险的渴望。
...
1. **场景一：厨房**
   - "I need to buy a new microwave because my old one is broken."
   - "我需要买一个新的微波炉，因为我的旧的那个坏了。"

2. **场景二：家庭维修**
   - "The repairman came to fix our broken washing machine."
   - "修理工来修理我们坏掉的洗衣机。"

3. **场景三：工业用途**
   - "The factory uses specialized appliances for manufacturing."
   - "工厂使用专门的设备进行制造。"
...
- **形容词**: approximate (大约的)
- **动词**: approximate (近似于)、approximated、approximating、approximates (第三人称单数)、approximation (名词形式)、approximately (副词形式)、approximator (名词形式)、approximate value (固定搭配:近似值)、approximate solution (固定搭配:近似解)、approximate calculation (固定搭配:近似计算)。  近似值,近似解,近似计算等。  英文翻译：approximate value, approximate solution, approximate calculation等.  近似值,近似解,近似计算等.  英文翻译：approximate value, approximate solution, approximate calculation等.  近似值,近似解,近似计算等.  英文翻译：approximate value, approximate solution, approximate calculation等.  近似值,近似解,近似计算等.  英文翻译：approximate value, approximate solution, approximate calculation等.  近似值,近似解,
...
1. The architecture of the ancient Greek temples is renowned for its beauty and symmetry.  
   古希腊神庙的建筑以其美丽和对称性而闻名。

2. Modern architecture often incorporates sustainable materials to reduce environmental impact.  
   现代建筑通常采用可持续材料以减少对环境的影响。

3. The architect spent years studying the history of architecture before designing his first building.  
   这位建筑师在设计他的第一座建筑之前，花了数年时间研究建筑史。
...
### 列举例句
1. **场景一：家庭讨论**
   - "They often argue about politics at the dinner table."
   - "他们经常在餐桌上就政治问题进行争论。"

2. **场景二：工作场合**
   - "The team members argued over the best strategy for the project."
   - "团队成员就项目的最佳策略进行了争论。"

3. **场景三：法律辩论**
   - "The lawyers argued passionately in court."
   - "律师们在法庭上激烈地辩论。"
...
1. **场景一：科技**
   - "The company developed an artificial intelligence system to assist with customer service."
   - “公司开发了一套人工智能系统来协助客户服务。”

2. **场景二：园艺**
   - "She planted artificial flowers in the garden because she didn't have time to care for real ones."
   - “她在花园里种了假花，因为她没有时间照顾真花。”

3. **场景三：医学**
   - "The patient received an artificial heart after his natural one failed."
   - “病人在他的自然心脏衰竭后接受了一颗人工心脏。”
...
1. The painter's latest work is truly artistic.  
   **翻译**: 这位画家的最新作品确实很有艺术性。

2. She has an artistic way of arranging flowers.  
   **翻译**: 她插花的方式很有艺术感。

3. The ballet performance was nothing short of artistic perfection.  
   **翻译**: 这场芭蕾表演堪称艺术的完美呈现。
...
2. **场景二：社会规范**
   - The boy was ashamed of his dirty clothes in front of the class.
   - 男孩在全班同学面前因为自己脏兮兮的衣服而感到羞愧。
   
3. **场景三：道德行为**
   - He was ashamed of not helping the old lady cross the street.
   - 他因为没有帮助老妇人过马路而感到羞愧。
...
### 列举例句
1. **场景一：工作环境**
   - She often assists her boss with important tasks.
   - 她经常帮助她的老板处理重要任务。

2. **场景二：体育比赛**
   - The coach asked the new player to assist in the defense.
   - 教练要求新球员协助防守。
...
- **固定搭配**：assist with（帮助做某事），assist in（在...中协助）。
   - He assisted with the preparation of the report.（他协助准备报告。）
   - She assisted in organizing the event.（她在组织活动中协助。）
...
- **复数形式**: assistance 是不可数名词，没有复数形式。但可以加上量词如 "pieces of assistance"（几项帮助）来表示数量。例如: "We received several pieces of assistance from the community."（我们从社区得到了几项帮助）。  我们从社区得到了几项帮助。）））））））））））））））））
...
2. **场景二：社交关系**
   - He doesn't like to associate with dishonest people.
   - 他不喜欢和不诚实的人交往。
   
3. **场景三：联想**
   - I always associate the smell of lavender with my grandmother's garden.
   - 我总是把薰衣草的香味和我祖母的花园联系在一起。
...
### 列举例句
1. **场景一：学术讨论**
   - "Let's assume that the data is correct for now."
   - "让我们暂时假设数据是正确的。"

2. **场景二：工作环境**
   - "He assumed the role of project manager."
   - "他承担了项目经理的角色。"

3. **场景三：日常对话**
   - "Don't assume anything; ask for clarification."
   - "不要做任何假设；要求澄清。"
...
1. **场景一：商业环境**
   - The manager assured the client that the project would be completed on time.
   - 经理向客户保证项目将按时完成。

2. **场景二：医疗环境**
   - The doctor assured the patient that the surgery was completely safe.
   - 医生向病人保证手术是完全安全的。

3. **场景三：个人关系**
   - She assured her friend that she would be there to support her no matter what.
   - 她向朋友保证，无论发生什么，她都会在那里支持她。
...
1. The magician's trick astonished the audience.  
   **翻译**: 魔术师的把戏让观众感到惊讶。
2. She was astonished to see her old friend after so many years.  
   **翻译**: 多年后见到老朋友，她感到非常惊讶。
3. The news of his sudden resignation astonished everyone in the office.  
...
2. Many transatlantic flights connect Europe and North America.  
   **翻译**: 许多跨大西洋航班连接着欧洲和北美洲。
   
3. The Atlantic salmon is a popular fish for sport fishing.  
   **翻译**: 大西洋鲑鱼是运动钓鱼的热门鱼种。
...
1. **场景一：学术成就**
   - She worked hard and finally attained her PhD.
   - 她努力学习，最终获得了博士学位。

2. **场景二：职业目标**
   - He attained the position of CEO after years of dedication.
   - 经过多年的奉献，他达到了首席执行官的职位。

3. **场景三：个人成长**
   - By practicing daily, she was able to attain a high level of proficiency in piano.
   - 通过每天练习，她能够达到钢琴演奏的高水平。
...
1. **场景一：学习**
   - She made an attempt to solve the math problem.
   - 她尝试解决那道数学题。

2. **场景二：工作**
   - The company is attempting to enter the new market.
   - 公司正试图进入新市场。

3. **场景三：运动**
   - He attempted a difficult jump but failed.
   - 他尝试了一个高难度的跳跃，但失败了。
...
1. **场景一：日常对话**
   - "I drive an automobile to work every day."
   - "我每天开车去上班。"
   
2. **场景二：技术讨论**
   - "The automobile industry is rapidly evolving with the advent of electric vehicles."
   - "随着电动汽车的兴起，汽车工业正在迅速发展。"
   
3. **场景三：历史背景**
   - "The invention of the automobile revolutionized transportation in the early 20th century."
   - "汽车的发明在20世纪初彻底改变了交通运输方式。"
...
1. **场景一：城市街道**
   - "We walked down the beautiful tree-lined avenue."
   - "我们沿着那条美丽的林荫大道走去。"

2. **场景二：商业区**
   - "The shopping avenue was bustling with people."
   - "购物大街上人潮涌动。"

3. **场景三：路径**
   - "Hard work is the avenue to success."
   - "努力工作是通往成功的途径。"
...
1. **场景一：日常对话**
   - "I was aware of the danger before it happened."
   - "我在事情发生之前就意识到了危险。"

2. **场景二：工作环境**
   - "The manager is fully aware of the team's progress."
   - "经理完全了解团队的进展情况。"

3. **场景三：学习环境**
   - "Students should be aware of the importance of regular exercise."
   - "学生们应该意识到定期锻炼的重要性。"
...
2. **场景二：肢体动作**
   - "He made an awkward movement while trying to catch the ball."
   - "他在试图接球时做出了一个笨拙的动作。"

3. **场景三：情境处理**
   - "The situation became awkward when no one knew how to respond to the question."
   - "当没有人知道如何回答这个问题时，情况变得尴尬。"
