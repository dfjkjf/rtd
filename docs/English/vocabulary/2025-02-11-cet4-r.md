...
2. **场景二：学习**
   - She needs to read the instructions carefully before starting the experiment.
   - 她在开始实验前需要仔细阅读说明。

3. **场景三：电子设备**
   - Can you read the text on the screen from here?
   - 你能从这里读到屏幕上的文字吗？
...
1. **场景一：学校**
   - "The teacher asked the students to do some reading before the class."
   - "老师要求学生在课前进行一些阅读。"
   
2. **场景二：图书馆**
   - "She spends her weekends in the library, enjoying reading."
   - "她周末在图书馆度过，享受阅读的乐趣。"
   
3. **场景三：家庭**
   - "The children were encouraged to develop a habit of daily reading."
   - "孩子们被鼓励养成每天阅读的习惯。"
...
3. **场景三：描述经历**  
   - He experienced real poverty during his childhood.  
   - 他在童年时期经历了真正的贫困。
...
- **组词**: self-realization (自我实现), unrealized potential (未开发的潜力)
   ...
   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力。   自我实现是个人成长的关键方面。公司在亚洲市场有很多未开发的潜力
...
3. **动词用法**：
   - "She reasoned that the experiment would fail."
   - 她推断实验会失败。
...
### 单词变形
- **形容词**: reasonable（合理的）
- **副词**: reasonably（合理地）例如：He spoke reasonably during the debate.（他在辩论中发言合理。）  他在辩论中发言合理。)
...
1. **场景一：记忆**
   - "She was able to recall the details of the meeting."
   - "她能够回忆起会议的细节。"

2. **场景二：召回**
   - "The company issued a recall for all defective products."
   - "公司对所有有缺陷的产品发出了召回令。"

3. **场景三：收回**
   - "The general decided to recall his troops from the front line."
   - "将军决定从前线召回他的部队。"
...
2. **场景二：确认收到物品**
   - "Upon receipt of the package, please sign here."
   - “收到包裹后，请在这里签字。”

3. **场景三：财务记录**
   - "The accountant asked for all the receipts from last month's expenses."
   - “会计要求提供上个月所有费用的收据。”
...
### 列举例句
1. **场景一：新闻报道**  
   - "The recent earthquake caused significant damage to the city."  
   - “最近的地震对城市造成了重大破坏。”

2. **场景二：个人经历**  
   - "I visited my grandparents last week; it was their first time meeting my recent baby."  
   - “我上周去看望了我的祖父母；这是他们第一次见到我最近出生的宝宝。”

3. **场景三：学术讨论**  
   - "Recent studies have shown that meditation can improve mental health."  
   - “最近的研究表明，冥想可以改善心理健康。”
...
### 列举例句
1. **场景一：认出某人**
   - I recognized her immediately as she walked into the room.
   - 她一走进房间，我立刻就认出了她。

2. **场景二：承认事实**
   - The company recognized the importance of going green.
   - 公司承认了环保的重要性。

3. **场景三：识别声音**
   - Can you recognize that song? It sounds familiar.
   - 你能识别那首歌吗？听起来很熟悉。
...
1. **场景1：工作推荐信**
   - She received a strong recommendation from her previous employer.
   - 她收到了前雇主的强烈推荐。

2. **场景2：餐厅推荐**
   - Can you give me a recommendation for a good restaurant in the area?
   - 你能给我推荐一下这附近的好餐厅吗？

3. **场景3：产品建议**
   - The product comes with a detailed user recommendation.
   - 该产品附有详细的用户建议。
...
3. **场景三：记录工具**
   - He kept a recorder to document his daily thoughts.
   - 他用录音机记录每天的想法。
...
1. **场景一：健康与饮食**
   - "To maintain a healthy weight, you should reduce your sugar intake."
   - "为了保持健康的体重，你应该减少糖的摄入。"

2. **场景二：工作效率**
   - "By using this software, we can reduce the time needed for data analysis."
   - "通过使用这个软件，我们可以减少数据分析所需的时间。"
...
1. **场景一：学术讨论**
   - During the presentation, she often referred to her notes to ensure accuracy.
   - 在演讲中，她经常参考她的笔记以确保准确性。

2. **场景二：寻求帮助**
   - If you have any questions, please refer to the manual for detailed instructions.
   - 如果你有任何问题，请参阅手册以获取详细说明。

3. **场景三：法律文件**
   - The contract refers to the previous agreement in several clauses.
   - 合同在几个条款中提到了先前的协议。
...
1. **场景一：家庭生活**
   - "I always store my fruits and vegetables in the refrigerator to keep them fresh."
   - "我总是把水果和蔬菜放在冰箱里，以保持它们的新鲜。"

2. **场景二：厨房用具**
   - "The refrigerator in our kitchen is quite old, but it still works well."
   - "我们厨房里的冰箱很旧了，但它仍然很好用。"

3. **场景三：购物回家**
   - "After grocery shopping, I immediately put the perishable items in the refrigerator."
   - "购物回家后，我立即把易腐烂的物品放进冰箱。"
...
1. **场景一：工作中的拒绝**
   - "His refusal to cooperate led to the project's delay."
   - "他拒绝合作导致了项目的延迟。"

2. **场景二：社交中的拒绝**
   - "Her polite refusal to the invitation was understandable given her busy schedule."
   - "考虑到她繁忙的日程，她礼貌地拒绝了邀请是可以理解的。"

3. **场景三：法律中的拒绝**
   - "The court's refusal to grant bail was based on the severity of the crime."
   - "法院拒绝保释是基于罪行的严重性。"
...
### 列举例句
1. "Regarding the project, we need to finalize the budget by Friday."  
   **翻译**: “关于这个项目，我们需要在周五之前确定预算。”
2. "She asked me several questions regarding my experience in the field."  
   **翻译**: “她问了我几个关于我在该领域经验的问题。”
3. "Regarding your request, we will respond within two business days."  
...
2. **场景二：学习**  
   - "She studied hard regardless of her illness."  
   - "她不顾生病努力学习。"

3. **场景三：旅行**  
   - "They decided to go on the trip regardless of the weather forecast."  
   - "他们决定不管天气预报如何都要去旅行。"
...
1. **场景一：学校注册**
   - "Please register your name at the front desk before entering the classroom."
   - "进入教室前，请在前台登记你的名字。"
   
2. **场景二：声音清晰**
   - "The clock's bell registers clearly in the quiet room."
   - "钟的铃声在安静的房间里清晰地响起。"
   
3. **场景三：情感表达**
   - "Her surprise was registered on her face when she saw the gift."
   - "当她看到礼物时，她的惊讶之情显露在脸上。"
...
-  表达遗憾,感到遗憾,深深的遗憾,懊悔的,令人遗憾的,毫不后悔。
...
- **名词形式**: rejection（拒绝）；例如：He faced rejection from multiple companies.（他面对多家公司的拒绝。）  【他面对多家公司的拒绝】  【固定搭配：face rejection（面对拒绝）】  【组词：job rejection（工作拒绝）】  【工作拒绝】  【组词：application rejection（申请被拒）】  【申请被拒】  【组词：romantic rejection（感情上的拒绝）】  【感情上的拒绝】  【组词：proposal rejection（提案被拒）】  【提案被拒】  【组词：product rejection（产品被拒收）】  【产品被拒收】
...
从前，在一个小村庄里，村民们之间有着紧密的家庭关系。每个星期天，他们都会聚在一起分享故事和餐食。这种牢固的纽带帮助他们一起克服了任何挑战。
...
### 列举例句
1. **场景一：在家休息**
   - "After a long day at work, she likes to relax on the couch with a good book."
   - “经过一天的辛苦工作后，她喜欢在沙发上放松一下，读一本好书。”

2. **场景二：在健身房**
   - "The yoga instructor told us to relax our muscles and take deep breaths."
   - “瑜伽教练告诉我们放松肌肉，深呼吸。”

3. **场景三：在海滩**
   - "We spent the whole afternoon relaxing on the beach, listening to the sound of the waves."
   - “我们整个下午都在海滩上放松，听着海浪的声音。”
...
### 列举例句
1. **场景一：工作环境**
   - "My colleague is very reliable; she always completes her tasks on time."
   - 我的同事非常可靠，她总是按时完成任务。

2. **场景二：产品评价**
   - "This brand of laptop is known for being reliable and durable."
   - 这个品牌的笔记本电脑以可靠和耐用著称。
...
1. **场景一：医疗**
   - Taking painkillers can relieve the headache.
   - 吃止痛药可以缓解头痛。

2. **场景二：工作压力**
   - Listening to music helps relieve stress after a long day at work.
   - 听音乐有助于在长时间工作后缓解压力。

3. **场景三：军事**
   - The reinforcements were sent to relieve the besieged troops.
   - 增援部队被派去解救被围困的部队。
...
- **相同后缀的单词**: 
  - Ambitious: 有雄心的，有野心的。例如：He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）  他有成为CEO的雄心。  英文He is ambitious to become a CEO.（他有成为CEO的雄心。）
...
2. **场景二：工作环境**
   - My team relies on me to complete the project on time.
   - 我的团队依赖我按时完成项目。
...
1. **场景一：会议中的发言**  
   - "During the meeting, John made a remark about the new project's timeline."  
   - "在会议上，约翰对新项目的进度发表了评论。"
   
2. **场景二：课堂上的观察**  
   - "The teacher remarked on the students' improved performance."  
   - "老师对学生们的进步表现进行了评论。"
   
3. **场景三：社交场合的闲聊**  
   - "She made a remark about the weather, starting a conversation."  
   - "她对天气发表了评论，从而开始了对话。"
...
### 列举例句
1. **场景一：学术成就**
   - She achieved a remarkable score on her exam.
   - 她在考试中取得了显著的成绩。

2. **场景二：艺术作品**
   - The painting is remarkable for its vivid colors.
   - 这幅画因其生动的色彩而引人注目。

3. **场景三：个人特质**
   - He is remarkable for his patience and kindness.
   - 他以耐心和善良著称。
...
- 显著地差异, 非凡的成就, 非常有才华的, 非常相似的, 产生显著差异, 一项非凡的成就, 非常有才华的人, 非常相似的事物。
...
1. "A good night's sleep is the best remedy for a headache."  
   **翻译**: "一夜好眠是治疗头痛的最佳方法。"

2. "The government is working on a remedy for the economic crisis."  
   **翻译**: "政府正在寻找解决经济危机的办法。"

3. "Herbal remedies have been used for centuries to treat various ailments."  
...
2. **场景二：学习**
   - "I can't remember the name of that movie we watched last week."
   - "我记不起我们上周看的那部电影的名字了。"

3. **场景三：情感回忆**
   - "She remembered the day they first met with a smile."
   - "她微笑着回忆起他们第一次见面的那天。"
...
2. **场景二：回忆过去**
   - "This photo reminds me of our trip to Paris."
   - "这张照片让我想起了我们去巴黎的旅行。"

3. **场景三：提醒某人做某事**
   - "She reminded her son to do his homework before playing video games."
   - "她提醒儿子在玩游戏之前先做作业。"
...
- **组词**: furniture removal (家具搬运), policy removal (政策取消)  
  家具搬运,   政策取消,   搬家公司,   搬家货车,   移除过程.   可移除的.   移除,   搬迁.    移除,   搬迁.    家具搬运,   政策取消.    搬家公司,   搬家货车,   移除过程.    可移除的.    移除,    搬迁.    家具搬运,    政策取消.    搬家公司,    搬家货车,    移除过程.    可移除的.    移除,    搬迁.    家具搬运,    政策取消.    搬家公司,    搬家货车,    移除过程.    可移除的.    移除,
...
2. **场景二：工作中的移除**
   - The manager decided to remove John from the project team.
   - 经理决定将约翰从项目团队中移除。
   
3. **场景三：技术操作中的移除**
   - To remove the virus, you need to install an antivirus software.
   - 要删除病毒，你需要安装杀毒软件。
...
- **衍生词**: 
  ...
  这些单词都与“重复”的概念相关。  
- "Repetition is often used in language learning to reinforce memory."（在语言学习中，重复常用于强化记忆。）"The task became repetitive after a while."（这项任务过了一会儿就变得单调了。）"She worked as a repetitor for the language class."（她在语言课上担任辅导员。）  
- **记忆技巧**: *peat* (泥炭)可以想象成一种需要不断挖掘的东西，就像我们需要不断重复学习一样。所以*repeat*就是不断挖掘、再次带来的意思。  
- **小故事**: "Tom forgot his keys, so he had to repeat his way back home."（汤姆忘记带钥匙了，所以他不得不原路返回家中。）汤姆忘记带钥匙了，所以他不得不原路返回家中。
...
1. "The teacher asked the students to practice the new vocabulary through repetition."
   - **翻译**: "老师要求学生通过重复来练习新词汇。"
2. "Repetition of the same mistakes can lead to failure."
   - **翻译**: "重复同样的错误可能导致失败。"
3. "The repetition of the word 'love' in the poem emphasized its importance."
...
1. **场景一：电子邮件**
   - I sent him an email, but he hasn't replied yet.
   - 我给他发了一封电子邮件，但他还没有回复。

2. **场景二：对话**
   - When I asked her about the project, she replied that it was almost finished.
   - 当我问她关于项目的事情时，她回答说已经差不多完成了。

3. **场景三：社交媒体**
   - He left a comment on my post, and I replied with a smiley face.
   - 他在我的帖子下留言，我回复了一个笑脸。
...
1. **场景一：商业环境**
   - "The sales representative will meet with clients to discuss their needs."
   - "销售代表将与客户会面，讨论他们的需求。"
   
2. **场景二：政治环境**
   - "The representative from the opposition party gave a powerful speech."
   - "反对党代表发表了一场有力的演讲。"
...
1. **场景一：历史课**  
   - "The Roman Republic was one of the earliest examples of a republic in history."  
   - "罗马共和国是历史上最早的共和国之一。"

2. **场景二：政治讨论**  
   - "In a republic, the power is vested in the people, who elect their leaders."  
   - "在共和国中，权力属于人民，他们选举自己的领导人。"

3. **场景三：新闻报道**  
   - "The newly formed republic is facing challenges in establishing a stable government."  
   - "新成立的共和国在建立稳定政府方面面临挑战。"
...
### 列举例句
1. **场景一：个人声誉**
   - "She has a good reputation in the community for her volunteer work."
   - "她在社区中因志愿工作而享有良好的声誉。"
...
3. **场景三：品牌声誉**
   - "This brand has a reputation for producing high-quality products."
   - "这个品牌以生产高质量产品而闻名。"
...
1. **场景一：在商店**
   - "I made a request for a refund because the product was damaged."
   - “我请求退款，因为产品损坏了。”
...
3. **场景三：在音乐会上**
   - "The audience requested an encore by clapping loudly."
   - “观众通过热烈鼓掌要求再来一首。”
...
2. **场景二：性格相似**
   - My brother and I resemble each other in temperament.
   - 我和我弟弟在性格上很像。
...
### 列举例句
1. **场景一：描述住所**
   - She has a beautiful residence in the countryside.
   - 她在乡下有一处美丽的住所。

2. **场景二：法律文件**
   - According to the law, his official residence is in New York.
   - 根据法律，他的正式居住地是在纽约。

3. **场景三：学术环境**
   - The university offers on-campus residences for students.
   - 这所大学为学生提供校内宿舍。
...
2. **场景二：个人决定**
   - She resigned herself to the fact that she would never walk again.
   - 她无奈地接受了自己再也无法行走的事实。

3. **场景三：体育比赛**
   - The player resigned after the second set due to an injury.
   - 这位选手因受伤在第二盘后退赛。
...
### 列举例句
1. **场景一：抵抗诱惑**
   - She tried to resist the temptation of chocolate.
   - 她试图抵抗巧克力的诱惑。
...
3. **场景三：抵制变化**
   - Many people resist change, even when it's for the better.
   - 许多人抵制变化，即使这种变化是更好的。
...
1. **解决问题的场景**：
   - "The team worked together to resolve the technical issue."
   - "团队一起努力解决了技术问题。"
   
2. **下定决心的场景**：
   - "She resolved to study harder for her exams."
   - "她决定为考试更加努力学习。"
...
4. **决心的场景（名词）**：
   - "His resolve to quit smoking was unwavering."
   - "他戒烟的决心坚定不移。" （注：这里resolve作为名词使用） —— 这个例子展示了resolve作为名词的用法，表示“决心”或“坚定的意志”。 —— 这种用法在日常英语中也很常见，尤其是在表达某人坚持做某事的决心时。 —— 例如，可以说“Her resolve to finish the marathon was strong.”（她完成马拉松的决心很坚定）。
...
1. The students went to their respective dormitories after class.  
   **翻译**: 学生们下课后回到了各自的宿舍。  

2. Each team member was given a task according to their respective strengths.  
   **翻译**: 每个团队成员都根据各自的优势被分配了任务。  

3. The two friends said goodbye and headed to their respective homes.  
   **翻译**: 两个朋友道别后各自回家了。  
...
2. **场景二：工作环境**
   - The manager responded promptly to the email.
   - 经理迅速回复了邮件。

3. **场景三：紧急情况**
   - The paramedics responded quickly to the emergency call.
   - 急救人员迅速响应了紧急呼叫。
...
### 列举例句
1. **场景一：日常对话**
   - "His response to the question was immediate."
   - 他对问题的回答是即时的。

2. **场景二：工作环境**
   - "The company's response to the customer complaint was swift and effective."
   - 公司对客户投诉的回应迅速且有效。
...
### 列举例句
1. **场景一：个人行为控制**
   - She tried to restrain her anger during the argument.
   - 她在争论中试图抑制自己的愤怒。
...
3. **场景三：情感管理**
   - He couldn't restrain his tears when he heard the sad news.
   - 当他听到这个悲伤的消息时，他无法抑制自己的眼泪。
...
- **名词**: retention (保留)、retainer (保持者)。例如：The lawyer's retainer fee was paid in advance. (律师的预付费已提前支付)。律师的预付费已提前支付。保留费已预付给律师了。记住费已预先付给律师了。留置费已预先付给律师了。留存费已预先付给律师了。留置金已预先付给律师了。留存金已预先付给律师了。留置费已预先支付给律师了。留存费已预先支付给律师了。留置金已预先支付给律师了。留存金已预先支付给律师了。留置费已经提前付给了律师了。留存费已经提前付给了律师了
...
2. **场景**: 在科学研究中  
   The experiment revealed surprising results.  
   **翻译**: 实验揭示了令人惊讶的结果。

3. **场景**: 在艺术展览中  
   The artist revealed his new painting to the public.  
   **翻译**: 艺术家向公众展示了他的新画作。
...
1. **场景：工作表现**  
   ...
   - 公司决定为员工的辛勤工作发放奖金作为奖励。

2. **场景：学习成就**  
   - She received a reward for being the top student in her class.  
   - 她因在班上成绩优异而获得奖励。

3. **场景：宠物训练**  
   - The dog was rewarded with a treat after successfully completing the trick.  
   - 狗在成功完成把戏后得到了零食作为奖励。
...
2. **场景二：建筑**
   - The roof of the barn was supported by wooden ribs.
   - 谷仓的屋顶由木制肋条支撑。

3. **场景三：纺织品**
   - This sweater has a ribbed pattern, making it more stretchable.
   - 这件毛衣有棱纹图案，使其更具弹性。
...
### 列举例句
1. **场景一：家庭清洁**
   - "We need to rid the house of pests."
   - "我们需要清除房子里的害虫。"
   
2. **场景二：个人习惯**
   - "She decided to rid herself of bad habits."
   - "她决定改掉自己的坏习惯。"
   
3. **场景三：工作环境**
   - "The manager wants to rid the office of unnecessary paperwork."
   - "经理想清除办公室里不必要的文件。"
...
1. **场景一：交通**
   - The new bridge will reduce travel time between the two cities.
   - 这座新桥将缩短两座城市之间的旅行时间。
   
2. **场景二：沟通**
   - She tried to bridge the gap between her parents and herself.
   - 她试图弥合她与父母之间的隔阂。
   
3. **场景三：音乐**
   - The pianist used a bridge to connect the two sections of the piece.
   - 钢琴家用一个过渡段将作品的两个部分连接起来。
...
- **动词**: rifle (翻找), rifled, rifling, rifles (翻找) [翻找] [固定搭配：rifle through (翻找)] [组词：rifle range (射击场)] [射击场] [组词：rifleman (步枪手)] [步枪手] [组词：rifled barrel (有膛线的枪管)] [有膛线的枪管] [组词：rifle shot (步枪射击)] [步枪射击] [组词：rifle cartridge (步枪子弹)] [步枪子弹] [组词：rifle grenade (步枪榴弹)] [步枪榴弹] [组词：rifle scope (步枪瞄准镜)] [步枪瞄准镜] [组词：rifle stock (步枪托)] [步枪托] [组词：rifle butt (步枪尾端)] [步枪尾端] [组词：rifle sling (步枪背带)] [步枪背带] [组词：rifle range officer (射击场指挥官)] [射击场指挥官] [组词
...
1. **场景一：烹饪**
   - She loves to roast a chicken in the oven.
   - 她喜欢在烤箱里烤鸡。
   
2. **场景二：社交聚会**
   - The office had a roast for the retiring manager.
   - 办公室为即将退休的经理举行了一场调侃会。
   
3. **场景三：批评**
   - He was given a roast by his colleagues for his poor performance.
   - 他因表现不佳而受到同事们的批评。
...
2. **场景：工作**
   - The woman in the red dress is our new manager.
   - 穿红裙子的那位女士是我们的新经理。
...
1. **场景一：描述爱情**
   - They had a romantic dinner on the beach under the stars.  
   - 他们在星空下的海滩上享用了一顿浪漫的晚餐。
   
2. **场景二：描述文学作品**
   - The novel is a romantic depiction of medieval life.  
   - 这本小说以浪漫的方式描绘了中世纪的生活。
   
3. **场景三：描述个人特质**
   - She is a very romantic person who believes in true love.  
   - 她是一个非常浪漫的人，相信真爱。
...
- **名词形式：** rotary（作为名词时指“环形交叉口”或“旋转装置”）；复数形式为 rotaries。  例如：The city has several rotaries to manage traffic flow. (这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)  这个城市有几个环形交叉口来管理交通流量。)
...
- rotated (已旋转)；rotating (正在旋转)；rotates (旋转)  
- **复数形式**: N/A (动词无复数形式)  
...
1. "I follow a strict routine every morning to ensure I have enough time for everything."  
   **翻译**: "我每天早上都遵循严格的日常安排，以确保我有足够的时间完成所有事情。"

2. "Exercising is part of my daily routine."  
   **翻译**: "锻炼是我日常生活中的例行活动。"

3. "The doctor performed a routine check-up on the patient."  
   **翻译**: "医生对病人进行了常规检查。"
...
1. **场景一：日常生活**
   - "I always feel a rush when I see my favorite band perform live."
   - **翻译**: "当我看到我最喜欢的乐队现场表演时，我总是感到一阵兴奋。"
   
2. **场景二：工作环境**
   - "The manager rushed the team to complete the project before the deadline."
   - **翻译**: "经理催促团队在截止日期前完成项目。"
   
3. **场景三：交通高峰期**
   - "During the morning rush hour, the streets are always crowded."
   - **翻译**: "在早高峰期间，街道总是很拥挤。"
