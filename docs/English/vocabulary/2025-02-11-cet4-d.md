...
2. "She has been working in this company for over a decade."  
   **翻译**: “她在这家公司工作了十多年。”
...
3. He was deceived into thinking he had won the lottery.  
   **翻译**: 他被欺骗，以为自己赢了彩票。
...
### 列举例句
1. **场景：日历**  
   - "I have a meeting scheduled for December 15th."  
   - "我有一个会议安排在12月15日。"

2. **场景：节日**  
   - "December is a month full of celebrations, like Christmas and New Year's Eve."  
   - "十二月是一个充满庆祝活动的月份，比如圣诞节和新年夜。"

3. **场景：天气**  
   - "In December, the weather in New York is usually very cold."  
   - "在十二月，纽约的天气通常非常寒冷。"
...
- **固定搭配**: 
  1. Decent behavior（得体的行为）；得体的行为；符合社会规范的行为；合乎礼仪的行为；端庄的行为；有教养的行为；有礼貌的行为；有风度的行为；举止文雅的行为；举止端庄的行为；举止得体的行为；举止优雅的行为；举止大方
...
2. **场景二：团队讨论**
   - The committee will decide on the new project next week.
   - 委员会将在下周决定新项目。
...
- **固定搭配**：  
  ...
  - on deck（准备就绪；在场）  
    - The next speaker is on deck and ready to present.  
      （下一位演讲者已经准备就绪并准备发言。）  
      下一位演讲者已经准备好并准备发言。）   士兵听到枪声后立即卧倒。)   她在开始游戏前洗了牌。)   水手走过甲板去检查绳索。)   孩子们决定用彩色装饰品装饰圣诞树。)   下一位演讲者已经准备好并准备发言。)   士兵听到枪声后立即卧倒。)   她在开始游戏前洗了牌。)   水手走过甲板去检查绳索。)   孩子们决定用彩色装饰品装饰圣诞树。)   下一位演讲者已经准备好并准备发言。)   中文翻译
...
1. She loves to decorate her room with colorful posters.  
   **翻译**: 她喜欢用彩色海报装饰她的房间。

2. The restaurant was decorated with festive lights for the holiday season.  
   **翻译**: 餐厅为了节日季用节日灯饰进行了装饰。

3. They decided to decorate the Christmas tree together.  
   **翻译**: 他们决定一起装饰圣诞树。
...
- 减少, 降低, 下降, 递减, 减退, 减低, 缩减, 减缩, 削减, 减弱, 减轻, 缩小, 衰退, 减退, 退化, 衰退,减退力等。
...
1. From the evidence, the detective was able to deduce who the murderer was.  
   **翻译**: 根据证据，侦探能够推断出凶手是谁。

2. She deduced that the meeting had been postponed by looking at the empty conference room.  
   **翻译**: 她通过观察空无一人的会议室，推断出会议被推迟了。

3. By analyzing the data, scientists can deduce the patterns of climate change.  
...
- **组词**: deepen (使变深), deep-rooted (根深蒂固的), deep sea (深海)
   ...
   河流随着向下游流动而变深；她对蘑菇的厌恶是根深蒂固的；深海是许多神秘生物的家园。   	Deepen: The river deepened as it flowed downstream. Deep-rooted: Her dislike for mushrooms is deep-rooted. Deep sea: The deep sea is home to many mysterious creatures.   河流随着向下游流动而变深；她对蘑菇的厌恶是根深蒂固的；深海是许多神秘生物的家园。   	Deepen: The river deepened as it flowed downstream. Deep-rooted: Her dislike for mushrooms is deep-rooted. Deep sea: The deep sea is home to many mysterious creatures.   河流随着向下游流动而变深；她对蘑菇的厌恶是根深蒂固的；深海是许多神秘生物的家园。   	Deepen: The river deepened as it flowed downstream. Deep-rooted: Her dislike for mushrooms is deep-rooted. Deep sea: The deep sea is home to many mysterious creatures.   河流随着向下游流动而变深；她对蘑菇的厌恶是根深蒂固的；
...
2. **场景二：战争**
   - The general's strategy led to the defeat of the enemy forces.
   - 将军的策略导致了敌军的战败。
   
3. **场景三：个人挑战**
   - Despite his efforts, he faced defeat in the interview.
   - 尽管他努力了，但在面试中他还是失败了。
...
1. **场景一：学术讨论**  
   - "Can you define the term 'globalization' for me?"  
   - "你能为我定义一下‘全球化’这个术语吗？"
...
### 列举例句
1. **场景一：学术讨论**  
   - "The professor gave a definite answer to the student's question."  
   - 教授对学生的问题给出了明确的答案。

2. **场景二：商业合同**  
   - "Both parties agreed on a definite date for the meeting."  
   - 双方就会议的明确日期达成了一致。

3. **场景三：日常交流**  
   - "She has a definite plan for her weekend."  
   - 她对周末有一个明确的计划。
...
2. **场景二：编辑文档**
   - She deleted the last paragraph before submitting the report.
   - 她在提交报告前删除了最后一段。

3. **场景三：社交媒体**
   - He accidentally deleted his entire post on social media.
   - 他不小心删除了他在社交媒体上的整个帖子。
...
### 列举例句
1. **场景一：餐厅用餐**  
   - The pasta tasted absolutely delicious.  
   - 这道意大利面尝起来非常美味。

2. **场景二：家庭聚餐**  
   - Mom’s homemade apple pie is always delicious.  
   - 妈妈自制的苹果派总是非常美味。
...
2. **场景二：社交场合**
   - The children's performance brought delight to the audience.
   - 孩子们的表演给观众带来了欢乐。

3. **场景三：日常生活**
   - A surprise party is a delightful way to celebrate someone's birthday.
   - 惊喜派对是庆祝生日的愉快方式。
...
- **组词**: delightful experience, delighted smile.
   - 愉快的经历，欣喜的微笑。 等。   等。   等。   等。   等。   等。   等。   等。   等。   等.
...
1. "The country is proud of its long-standing democracy."  
   **翻译**: "这个国家为其悠久的民主制度感到自豪。"

2. "Democracy allows citizens to have a say in how they are governed."  
   **翻译**: "民主让公民在如何被治理方面有发言权。"

3. "The principles of democracy include freedom of speech and the right to vote."  
   **翻译**: "民主的原则包括言论自由和投票权。"
...
### 列举例句
1. **场景一：旅行**  
   - We will depart for Paris at 6 a.m. tomorrow.  
   - 我们将在明天早上6点启程去巴黎。
   
2. **场景二：工作**  
   - After working for 30 years, he decided to depart from his job.  
   - 在为公司工作了30年后，他决定离职。
   
3. **场景三：告别**  
   - She departed with a smile, leaving everyone feeling nostalgic.  
   - 她微笑着离开了，让大家感到依依不舍。
...
1. The HR department is responsible for hiring new employees.  
   **翻译**: 人力资源部门负责招聘新员工。

2. She works in the marketing department of a large corporation.  
   **翻译**: 她在一家大公司的市场营销部门工作。

3. The science department at the university is very well-equipped.  
   **翻译**: 大学里的科学系设备非常齐全。
...
-  部门,科,系,局,处,部,厅,司,所,室,组,股,队,班,排,连,营,团,旅,师,军,集团,公司,企业,工厂,学校,医院等组织中的一个独立分支或职能单位。
...
3. **场景：健康状况**
   - He became dependent on painkillers after the surgery.
   - 手术后，他变得依赖止痛药。
...
3. **场景三：自然沉积**
   - "Sediment deposits at the bottom of the lake were studied by scientists."
   - 科学家研究了湖底的沉积物。
...
2. **场景二：描述事件**
   - He described what happened during the accident.
   - 他描述了事故发生时的情况。

3. **场景三：描述感受**
   - They described their experience as unforgettable.
   - 他们形容他们的经历是难忘的。
...
1. "The book provides a detailed description of the author's travels."  
   **翻译**: 这本书详细描述了作者的旅行经历。

2. "Can you give me a description of the suspect?"  
   **翻译**: 你能给我描述一下嫌疑人的样子吗？

3. "The product description on the website was very accurate."  
   **翻译**: 网站上的产品描述非常准确。
...
1. **场景一：工作表现**
   - She worked hard all year and truly deserves the promotion.
   - 她全年努力工作，确实应该得到晋升。
...
3. **场景三：个人品质**
   - He is a kind and generous person who deserves happiness.
   - 他是一个善良慷慨的人，值得拥有幸福。
...
### 列举例句
1. **场景一：艺术与设计**
   - The architect is famous for his innovative designs.
   - 这位建筑师以其创新的设计而闻名。
   
2. **场景二：产品开发**
   - The company is designing a new smartphone.
   - 公司正在设计一款新的智能手机。
   
3. **场景三：计划与策略**
   - The campaign was designed to raise awareness about environmental issues.
   - 这场活动旨在提高人们对环境问题的认识。
...
2. **场景二：爱情中的渴望**
   - His desire for her grew stronger every day.
   - 他对她的渴望每天都在增强。
...
### 列举例句
1. **场景一：个人情感**
   - "After losing his job and home, he fell into despair."
   - “在失去工作和家后，他陷入了绝望。”
   
2. **场景二：文学作品**
   - "The hero's despair was palpable as he realized he had failed his mission."
   - “当英雄意识到自己未能完成任务时，他的绝望显而易见。”
   
3. **场景三：社会问题**
   - "The community faced despair after the natural disaster destroyed their homes."
   - “自然灾害摧毁了他们的家园后，社区陷入了绝望。”
...
1. **场景一：情感**
   - She was desperate for a solution to her financial problems.
   - 她迫切需要解决她的财务问题。
   
2. **场景二：行动**
   - In a desperate attempt to save his job, he worked 18 hours a day.
   - 为了保住工作，他拼命地每天工作18小时。
   
3. **场景三：环境**
   - The townspeople were desperate for water after the long drought.
   - 在长期干旱之后，镇上的人们迫切需要水。
...
2. **场景二：工作环境**
   - The manager despised employees who were always late.
   - 经理鄙视那些总是迟到的员工。

3. **场景三：道德观念**
   - Many people despise dishonesty in any form.
   - 许多人鄙视任何形式的不诚实。
...
2. His determination to succeed inspired everyone around him.  
   **翻译**: 他对成功的决心激励了他周围的每个人。

3. Despite the obstacles, her determination never wavered.  
   **翻译**: 尽管有障碍，她的决心从未动摇。
...
- 决心, 决定, 坚定, 坚决地, 展现决心, 有做某事的决心, 决心与毅力  
...
1. **场景：科技产品**
   - **** The smartphone is a sophisticated device that combines various functions.
   - **** 智能手机是一种结合了多种功能的复杂设备。

2. **场景：医疗设备**
   - **** The hospital has the latest medical devices to treat patients.
   - **** 这家医院配备了最新的医疗设备来治疗病人。

3. **场景：策略与手段**
   - **** She used a clever device to get the information she needed.
   - **** 她用了一个聪明的手段获取了她需要的信息。
...
1. She decided to devote her life to helping the poor.  
   **翻译**: 她决定将一生奉献给帮助穷人。

2. He devoted all his free time to studying for the exam.  
   **翻译**: 他把所有的空闲时间都用来准备考试。

3. The company has devoted significant resources to developing new technology.  
...
### 列举例句
1. **场景一：清晨的花园**  
   - The roses were glistening with dew in the early morning sunlight.  
   - 玫瑰在清晨的阳光下闪烁着露珠。

2. **场景二：夜晚的草地**  
   - I could feel the cool dew on the grass as I walked through the park at night.  
   - 我在夜晚穿过公园时，能感受到草地上凉爽的露水。

3. **场景三：诗歌中的意象**  
   - The poet described the dew as nature's gentle tears, falling silently onto the leaves.  
   - 诗人将露水描述为大自然温柔的眼泪，静静地落在叶子上。
...
1. **场景：地理差异**
   - "The people in the north of China speak a different dialect than those in the south."
   - "中国北方的人说的话和南方的人说的方言不同。"

2. **场景：社会文化**
   - "She grew up speaking a rural dialect, which made it difficult for her to communicate in the city."
   - "她从小说的是一种农村方言，这使得她在城市里交流很困难。"

3. **场景：历史背景**
   - "The ancient Greek dialect was preserved in some remote villages."
   - "古希腊方言在一些偏远的村庄中得以保存。"
...
2. **场景二：电影或戏剧中的对话**
   - "The dialog between the two characters was witty and engaging."
   - "两个角色之间的对话既机智又引人入胜。"

3. **场景三：国际会议中的对话**
   - "The international dialog on climate change is crucial for finding solutions."
   - "关于气候变化的国际对话对于寻找解决方案至关重要。"
...
1. The diameter of the circle is 10 centimeters.  
   **翻译**: 这个圆的直径是10厘米。
2. The tree trunk has a diameter of about 3 feet.  
   **翻译**: 这棵树干的直径大约是3英尺。
3. The engineer measured the diameter of the pipe to ensure it fit the specifications.  
...
1. **场景一：珠宝店**
   - She bought a diamond ring for her anniversary.
   - 她为纪念日买了一枚钻戒。

2. **场景二：自然科学**
   - Diamonds are formed deep within the Earth's crust under extreme pressure.
   - 钻石是在地球地壳深处的高压下形成的。

3. **场景三：比喻用法**
   - The athlete was awarded a diamond as a symbol of his excellence.
   - 这位运动员被授予一枚钻石，以象征他的卓越成就。
...
2. **场景二：历史记录**
   - The explorer's diary provided valuable information about his journey.
   - 探险家的日记为他旅程提供了宝贵的信息。

3. **场景三：文学作品**
   - The novel is written in the form of a diary, giving readers an intimate look into the protagonist's life.
   - 这部小说以日记的形式写成，让读者深入了解主角的生活。
...
### 列举例句
1. **场景一：描述物品的不同**  
   - These two pens are different colors.  
   - 这两支笔的颜色不同。
...
### 列举例句
1. **场景一：在花园里**
   - She is digging a hole to plant a tree.
   - 她正在挖一个洞来种树。
   
2. **场景二：考古**
   - Archaeologists are digging for ancient artifacts.
   - 考古学家正在挖掘古代文物。
   
3. **场景三：研究**
   - He spent hours digging into the company's financial records.
   - 他花了几个小时深入研究公司的财务记录。
...
1. **场景一：食物消化**
   - My stomach is having trouble digesting the spicy food.
   - 我的胃难以消化这些辣的食物。
   
2. **场景二：信息理解**
   - It took me a while to digest the complex information in the report.
   - 我花了一些时间才理解报告中的复杂信息。
   
3. **场景三：文摘**
   - I read the digest of the novel before deciding to buy it.
   - 我在决定购买这本小说之前先读了它的摘要。
...
### 列举例句
1. **场景一：电子设备**  
   - My phone has a digital camera that takes high-quality photos.  
   - 我的手机有一个可以拍摄高质量照片的数码相机。

2. **场景二：数据处理**  
   - The company uses digital tools to manage its customer data efficiently.  
   - 公司使用数字工具来高效管理客户数据。

3. **场景三：音乐**  
   - She prefers listening to digital music files rather than CDs.  
   - 她更喜欢听数字音乐文件，而不是CD。
...
2. The diligent worker received a promotion for his outstanding performance.  
   **翻译**: 这位勤奋的工人因表现出色而获得了晋升。

3. Despite the difficulties, he remained diligent in his studies.  
...
3. **场景三：正式晚宴**
   - The president hosted a state dinner for the visiting dignitaries.
   - 总统为来访的贵宾举办了一场国宴。
...
2. **场景二：技术**
   - The software update disabled the old version of the app.
   - 软件更新使旧版本的应用程序无法使用。

3. **场景三：社会**
   - The new policy aims to disable discrimination against minorities.
   - 新政策旨在消除对少数群体的歧视。
...
### 单词变形和固定搭配组词对应的disablement (名词), disabled (形容词), disabling (形容词)，disabling injury (使人丧失能力的伤害)，disabled person (残疾人)，disability (名词：残疾)。固定搭配如 "disable someone from doing something"（使某人不能做某事）。例如：The injury disabled him from playing football.（那次受伤使他无法踢足球。）
...
2. **场景二：学术讨论**
   - "The data from the experiment disagrees with our initial hypothesis."
   - "实验数据与我们的初始假设不符。"

3. **场景三：政治辩论**
   - "Many citizens disagree with the new tax policy."
   - "许多市民不同意新的税收政策。"
...
### 列举例句
1. **场景一：个人关系**
   - She was disappointed when he didn't show up for the date.
   - 当他没有赴约时，她感到很失望。

2. **场景二：工作或学习**
   - The students felt disappointed with the results of the exam.
   - 学生们对考试结果感到失望。

3. **场景三：产品或服务**
   - Many customers were disappointed by the poor quality of the product.
   - 许多顾客对产品质量差感到失望。
...
### 单词变形
- **名词形式**: disk, disks（复数形式）；磁盘、光盘等。  
- **动词形式**: (较少使用) to disk (将数据存储到磁盘上)；将...存入磁盘。  
- **形容词形式**: (较少使用) disk-shaped；圆盘形的。  
- **固定搭配**: hard disk（硬盘）, floppy disk（软盘）, optical disk（光盘）；硬盘、软盘、光盘等。  
- **组词**: disk drive（磁盘驱动器）, disk storage（磁盘存储）；磁盘驱动器、磁盘存储等。  
   - Example: The computer's disk drive is not working properly.  电脑的磁盘驱动器工作不正常。  
...
### 列举例句
1. **场景一：日常生活**
   - "She decided to discard the old furniture and buy new ones."
   - “她决定丢弃旧家具，买新的。”
   
2. **场景二：游戏**
   - "In the card game, you have to discard two cards before drawing new ones."
   - “在纸牌游戏中，你必须先丢弃两张牌，然后才能抽新的牌。”
   
3. **场景三：工作**
   - "The company discarded the old marketing strategy and adopted a new one."
   - “公司放弃了旧的营销策略，采用了新的策略。”
...
1. The report disclosed that the company had been involved in illegal activities.  
   **翻译**: 报告揭露该公司曾参与非法活动。
   
2. She decided to disclose her true feelings to him.  
   **翻译**: 她决定向他透露她的真实感受。
   
3. The lawyer asked the witness to disclose any relevant information.  
   **翻译**: 律师要求证人透露任何相关信息。
...
1. **场景一：学术讨论**
   - "We need to discuss the project details before the meeting."
   - "我们需要在会议前讨论项目细节。"
   
2. **场景二：家庭决策**
   - "Let's discuss where to go for vacation this year."
   - "让我们讨论一下今年去哪里度假。"
   
3. **场景三：工作汇报**
   - "The manager will discuss the new policies with the team."
   - "经理将与团队讨论新政策。"
...
### 列举例句
1. She wore a disguise to the party to avoid being recognized.  
   **翻译**: 她戴着伪装去参加派对，以免被认出来。
2. The detective disguised himself as a delivery man to catch the thief.  
   **翻译**: 侦探伪装成送货员来抓住小偷。
3. It was impossible to see through his disguise; he looked completely different.  
...
1. **餐具**：
   - Please pass me a clean dish.  
   - 请递给我一个干净的盘子。
   
2. **菜肴**：
   - The chef prepared a delicious dish for the special occasion.  
   - 厨师为这个特别场合准备了一道美味的菜肴。
   
3. **摆放**：
   - She dished up the pasta for everyone at the table.  
   - 她为桌上的每个人盛好了意大利面。
...
2. **场景二：商业行为**
   - The company's fraudulent practices led to dishonour in the business community.
   - 公司的欺诈行为导致了商业界的耻辱。

3. **场景三：法律案件**
   - The judge's bias in the case caused dishonour to the judicial system.
   - 法官在案件中的偏见导致了司法系统的耻辱。
...
2. **场景二：工作环境**
   - She dislikes working late nights.
   - 她不喜欢熬夜工作。

3. **场景三：社交互动**
   - He dislikes being interrupted during his presentation.
   - 他不喜欢在演讲时被打断。
...
### 列举例句
1. **场景一：商店陈列**
   - The store is displaying its latest collection of summer dresses.
   - 这家商店正在展示其最新的夏季连衣裙系列。
   
2. **场景二：电脑屏幕**
   - The computer's display shows an error message.
   - 电脑屏幕显示了一条错误信息。
   
3. **场景三：个人表现**
   - She displayed great courage during the competition.
   - 她在比赛中表现出了极大的勇气。
...
2. **场景二：安排时间**
   - "She needs to dispose her time wisely."
   - “她需要明智地安排时间。”

3. **场景三：处理情感**
   - "He couldn't dispose of his anger."
   - “他无法平息他的愤怒。”
...
1. **场景一：家庭**
   - His rude behavior displeased his parents.
   - 他的粗鲁行为惹恼了他的父母。

2. **场景二：工作**
   - The manager was displeased with the late submission of the report.
   - 经理对报告的迟交感到不满。

3. **场景三：社交**
   - Her constant interruptions displeased the speaker.
   - 她不断的打断让演讲者感到不快。
...
1. **场景一：区分颜色**
   - "She can distinguish between red and green easily."
   - "她能轻松地区分红色和绿色。"

2. **场景二：识别声音**
   - "He can distinguish his mother's voice from a crowd."
   - "他能在人群中识别出他母亲的声音。"

3. **场景三：使杰出**
   - "Her talent for music distinguishes her from her peers."
   - "她在音乐方面的才能使她从同龄人中脱颖而出。"
...
2. **场景二：自然环境**
   - "The construction noise disturbed the peace of the neighborhood."
   - "建筑噪音扰乱了社区的宁静。"

3. **场景三：情感状态**
   - "Her sudden appearance disturbed my thoughts."
   - "她的突然出现扰乱了我的思绪。"
...
1. **场景一：潜水**
   - She decided to dive into the crystal-clear water.
   - 她决定潜入清澈的水中。

2. **场景二：俯冲**
   - The bird suddenly dived down to catch the fish.
   - 鸟突然俯冲下去抓鱼。

3. **场景三：跳水**
   - He performed a perfect dive from the high board.
   - 他从高台上完成了一个完美的跳水动作。
...
- **形容词形式**: Diverse（多样的）。
- **固定搭配**: 
  - A diverse range of: 一系列多样的…（例如：a diverse range of opinions）。一系列多样的意见。  …意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…意见的多样性范围）；一系列多样的意见…
...
1. **** The teacher divided the class into small groups for the project.  
   **翻译：** 老师把班级分成小组来完成项目。
2. **** We need to divide the cake equally among all the guests.  
   **翻译：** 我们需要把蛋糕平均分给所有客人。
3. **** The river divides the city into two parts.  
   **翻译：** 这条河把城市分成了两部分。
...
1. **场景一：办公室环境**
   - "Please submit all the necessary documents before the deadline."
   - "请在截止日期前提交所有必要的文件。"
   
2. **场景二：历史记录**
   - "The historian documented the events of the revolution in great detail."
   - "历史学家详细地记录了革命的事件。"
   
3. **场景三：法律事务**
   - "The lawyer reviewed the legal documents carefully before presenting them in court."
   - "律师在法庭上提交之前仔细审查了法律文件。"
...
1. **场景一：家庭宠物**
   - My family has a dog named Max. He is very friendly and loves to play fetch.
   - 我家有一只名叫麦克斯的狗。他非常友好，喜欢玩接飞盘的游戏。

2. **场景二：工作犬**
   - The police use dogs to help track down criminals.
   - 警察使用狗来帮助追踪罪犯。

3. **场景三：情感陪伴**
   - After a long day at work, my dog always greets me with a wagging tail.
   - 在工作了一整天后，我的狗总是摇着尾巴迎接我。
...
### 列举例句
1. **场景一：购物**  
   - "She paid for the groceries with a hundred-dollar bill."  
   - 她用一张一百美元的钞票付了杂货的钱。

2. **场景二：旅行**  
   - "The exchange rate is 1.2 dollars to the euro today."  
   - 今天的汇率是1欧元兑换1.2美元。

3. **场景三：经济**  
   - "The company's profits have increased by millions of dollars this year."  
   - 今年公司的利润增加了数百万美元。
...
1. **场景一：家庭生活**
   - She is very good at domestic chores like cooking and cleaning.
   - 她非常擅长像做饭和打扫这样的家务活。

2. **场景二：国内事务**
   - The government is focusing on domestic issues rather than international affairs.
   - 政府正在关注国内问题，而不是国际事务。

3. **场景三：宠物**
   - Cats are one of the most common domestic animals.
   - 猫是最常见的家养动物之一。
...
2. **场景二：商业环境**
   - "The manager's office is located behind that door."
   - "经理的办公室在那扇门后面。"

3. **场景三：紧急情况**
   - "In case of fire, use the emergency exit door."
   - "发生火灾时，使用紧急出口门。"
...
1. The university has a new dormitory for first-year students.  
   **翻译**: 这所大学为一年级学生新建了一座宿舍。

2. She lives in a dormitory during the school year.  
   **翻译**: 她在学年期间住在宿舍里。

3. The dormitory rules require students to be quiet after 10 PM.  
...
2. **场景二：计算机界面**
   - The cursor is blinking on the screen, waiting for you to place a dot.
   - 光标在屏幕上闪烁，等待你放置一个点。
   
3. **场景三：装饰设计**
   - She painted a series of colorful dots on the canvas.
   - 她在画布上画了一系列彩色的小圆点。
...
- **名词**: doubtfulness（怀疑）
- **固定搭配**: 
  - "be doubtful of/about"（对...感到怀疑）: "She is doubtful of his intentions."（她对他的意图感到怀疑。）  【她对他的意图感到怀疑。】  【英文She is doubtful of his intentions.】  【她对他的意图感到怀疑。】
...
1. **场景一：家庭生活**
   - I left my keys downstairs.
   - 我把钥匙落在楼下了。

2. **场景二：工作环境**
   - The meeting is being held downstairs in the conference room.
   - 会议正在楼下会议室举行。

3. **场景三：公共场所**
   - Please take the elevator downstairs to the parking lot.
   - 请乘电梯下楼到停车场。
...
1. **名词用法**:
   - He submitted the first draft of his novel to his editor.  
     他把小说的第一稿提交给了编辑。
   - The draft for the new law is being discussed in the parliament.  
     新法律的草案正在议会中讨论。
   - There is a strong draft coming from the window.  
     从窗户吹进来一阵强风。
   
2. **动词用法**:
   - She drafted a letter to the company, expressing her concerns.  
     她起草了一封信给公司，表达她的担忧。
   - The military drafted young men into service during the war.  
     战争期间，军队征募了年轻人入伍。
...
### 列举例句
1. **场景一：神话故事**  
   - The knight fought bravely against the dragon to save the princess.  
   - 骑士勇敢地与龙战斗，以拯救公主。

2. **场景二：儿童书籍**  
   - The little boy dreamed of riding a dragon to faraway lands.  
   - 小男孩梦想着骑着龙去遥远的地方。

3. **场景三：电影台词**  
   - "You must be the legendary dragon warrior," said Master Shifu.  
   - “你一定是传说中的龙战士，”师傅说。
...
1. **场景一：绘画**
   - She loves to draw landscapes in her spare time.
   - 她喜欢在闲暇时间画风景。
...
3. **场景三：吸引注意**
   - The movie drew a large audience on its opening night.
   - 这部电影在首映夜吸引了大量观众。
...
1. **场景一：描述梦境**
   - I had a strange dream last night where I was flying over the city.
   - 昨晚我做了一个奇怪的梦，梦见自己在城市上空飞翔。
...
3. **场景三：讨论现实与梦想**
   - Sometimes reality can be far from our dreams.
   - 有时候现实可能与我们的梦想相去甚远。
...
2. **场景二：人际关系**
   - Over time, our friendship drifted apart.
   - 随着时间的推移，我们的友谊逐渐疏远了。
   
3. **场景三：天气现象**
   - The snowdrift outside the house was several feet high.
   - 房子外面的雪堆有几英尺高。
   
4. **场景四：经济趋势**
   - The company is trying to anticipate the drift of consumer preferences.
   - 公司正试图预测消费者偏好的变化趋势。
...
3. **场景三：描述饮酒行为**
   - "He doesn't drink alcohol because of his health."
   - "他因为健康原因不喝酒。"
...
- driver (司机), driveway (车道), driven (有动力的)
...
1. The swimmer accidentally drowned in the deep end of the pool.  
   **翻译**: 游泳者在深水区不小心淹死了。

2. The loud music drowned out his voice, making it impossible to hear him.  
   **翻译**: 音乐声太大，淹没了他的声音，使我们无法听到他说话。

3. The fields were drowned by the heavy rain, causing severe flooding.  
   **翻译**: 大雨淹没了田地，造成了严重的洪水。
...
1. **场景一：医疗用途**
   - The doctor prescribed a new drug to help with her pain.
   - 医生开了一种新药来帮助她缓解疼痛。

2. **场景二：非法药物**
   - The police arrested him for drug possession.
   - 警察因他持有毒品而逮捕了他。

3. **场景三：药物副作用**
   - She experienced some side effects from the drug.
   - 她服用了这种药物后出现了一些副作用。
...
### 列举例句
1. **场景一：音乐演奏**
   - The drummer played a fast rhythm on the drum.
   - 鼓手在鼓上演奏了一个快速的节奏。
   
2. **场景二：军事训练**
   - The soldiers marched to the sound of the drum.
   - 士兵们随着鼓声行进。
   
3. **场景三：自然现象**
   - The heavy rain drummed on the roof all night.
   - 大雨整晚都在屋顶上发出咚咚声。
...
2. She woke up with a terrible headache, realizing she had gotten drunk last night.  
   **翻译**: 她醒来时头痛欲裂，意识到自己昨晚喝醉了。

3. The police arrested several drunk drivers last night.  
   **翻译**: 昨晚警察逮捕了几名酒后驾车的司机。
...
1. **场景一：描述人的能力**
   - The accident left him dumb.
   - 那场事故让他变成了哑巴。

2. **场景二：形容事物**
   - This new gadget is so dumb; it doesn't even have a basic feature.
   - 这个新的小玩意儿真笨，连基本功能都没有。

3. **场景三：表达沉默**
   - She remained dumb, refusing to answer any questions.
   - 她保持沉默，拒绝回答任何问题。
...
### 记忆辅助技巧和窍门:  记忆 "durable" 可以通过以下方法：  1. 联想记忆：想象一个非常坚固的物品，比如一块石头（stone），它是非常持久的（durable）。  2. 重复使用：将 "durable" 应用到不同的场景中，比如家具、衣物等，通过实际应用来加深记忆。  3. 结合通过例句来理解单词的用法和含义，这样更容易记住。
...
3. **场景三：学校生活**
   - "She always takes notes during the lecture."
   - "她在上课期间总是做笔记。"
...
- **固定搭配**: "dust off" (重新使用；重新开始), "dust up" (激起；挑起)
   ...
   他决定重新拿起他的旧吉他开始弹奏。/这场争论真的挑起了一些旧的冲突。)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   他决定重新拿起他的旧吉他开始弹奏/这场争论真的挑起了一些旧的冲突.)   
...
### 列举例句
1. **场景一：工作职责**
   - "It is my duty to ensure the safety of all passengers."
   - "确保所有乘客的安全是我的职责。"

2. **场景二：家庭责任**
   - "Taking care of elderly parents is a duty that cannot be ignored."
   - "照顾年迈的父母是一项不容忽视的责任。"

3. **场景三：法律义务**
   - "Paying taxes is a legal duty for every citizen."
   - "纳税是每个公民的法律义务。"
